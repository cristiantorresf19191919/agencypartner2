...
const contentGroups: Array<{
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        id: "apollo-graphql",
        category: "course",
        href: "/developer-section/apollo-graphql",
        icon: RouteIcon,
        titleKey: "apollo-course-card-title",
        descKey: "apollo-course-card-desc",
        ctaKey: "start-course",
        difficulty: "advanced",
        tags: ["react", "typescript"],
      },
  ...
  },
  {
    ...
    cards: [
      ...
      {
        id: "apollo-graphql-challenges",
        category: "challenge",
        href: "/developer-section/apollo-graphql-challenges",
        icon: RouteIcon,
        titleKey: "apollo-challenges-card-title",
        descKey: "apollo-challenges-card-desc",
        ctaKey: "solve-apollo-challenges",
        difficulty: "advanced",
        tags: ["react", "typescript"],
      },
      {
