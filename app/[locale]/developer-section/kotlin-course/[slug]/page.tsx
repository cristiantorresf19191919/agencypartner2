...
import { getKotlinLessonById, type KotlinLesson, type KotlinPracticeChallenge } from "@/lib/kotlinCourseData";
...
export default function KotlinCourseLessonPage() {
  ...
  const lesson = getKotlinLessonById(slug);
  ...
  const uri = `file:///kotlin-lesson.kt`;
    ...
    return (
      <main className={styles.page}>
        ...
        <div className={playStyles.notFound}>
          ...
          <Link href={createLocalizedPath("/developer-section/kotlin-course")}>Back to course</Link>
        </div>
        <Footer />
      </main>
    );
