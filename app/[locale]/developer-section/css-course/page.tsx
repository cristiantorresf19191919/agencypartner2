  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.heroSection}>
        ...
        >
          Learn CSS Flexbox with the Enriched Editor
        </motion.h1>
        <motion.p
        ...
        <div className={styles.heroBadges}>
          ...
          <span className={styles.badge}>{CSS_COURSE_LESSONS.length} Steps</span>
        </div>
      </section>
      ...
      <section className={styles.listSection}>
        <div className={styles.filterBar}>
          ...
          <span className={styles.count}>{CSS_COURSE_LESSONS.length} lessons</span>
        </div>
