/**
 * React Interview Questions - comprehensive Q&A dataset.
 *
 * Source: github.com/sudheerj/reactjs-interview-questions (MIT License)
 * Adapted for the "Prepare for your Senior React Interview" section.
 *
 * Each entry contains markdown-formatted answer text (rendered with
 * react-markdown + remark-gfm) that may include fenced code blocks, tables,
 * lists, inline code, and <details> sections.
 */

export interface ReactInterviewQuestion {
  /** Stable slug used in URLs. */
  slug: string;
  /** Question number inside its section (as in the source repo). */
  num: number;
  ...
  category: ReactInterviewCategoryId;
}

export type ReactInterviewCategoryId =
  | "core"
  | "router"
  | "redux"
  | "testing"
...
export const REACT_INTERVIEW_QUESTIONS: ReactInterviewQuestion[] = [
  {
    slug: "core-what-is-react",
    num: 1,
    category: "core",
    title: "What is React?",
    answer: `React (aka React.js or ReactJS) is an **open-source front-end JavaScript library** for building user interfaces based on components. It's used for handling the view layer in web and mobile applications, and allows developers to create reusable UI components and manage the state of those components efficiently.
...
React was created by [Jordan Walke](https://github.com/jordwalke), a software engineer at Facebook (now Meta). It was first deployed on Facebook's News Feed in 2011 and on Instagram in 2012. The library was open-sourced in May 2013 and has since become one of the most popular JavaScript libraries for building modern user interfaces.`,
  ...
  {
    slug: "core-what-is-the-history-behind-react-evolution",
    num: 2,
    category: "core",
    title: "What is the history behind React evolution?",
    answer: `The history of ReactJS started in 2010 with the creation of **XHP**. XHP is a PHP extension which improved the syntax of the language such that XML document fragments become valid PHP expressions and the primary purpose was used to create custom and reusable HTML elements.
  ...
  {
    slug: "core-what-are-the-major-features-of-react",
    num: 3,
    category: "core",
    title: "What are the major features of React?",
    answer: `React offers a powerful set of features that have made it one of the most popular JavaScript libraries for building user interfaces:
...
These features collectively make React powerful for building everything from small widgets to complex, large-scale web applications.`,
  ...
  {
    slug: "core-what-is-jsx",
    num: 4,
    category: "core",
    title: "What is JSX?",
    answer: `_JSX_ stands for _JavaScript XML_ and it is an XML-like syntax extension to ECMAScript. Basically it just provides the syntactic sugar for the \`React.createElement(type, props, ...children)\` function, giving us expressiveness of JavaScript along with HTML like template syntax.
...
**Note:** JSX is stricter than HTML`,
  ...
  {
    slug: "core-what-is-the-difference-between-an-element-and-a-component",
    num: 5,
    category: "core",
  ...
  **In summary:**
  ...
  {
    slug: "core-how-to-create-components-in-react",
    num: 6,
    category: "core",
    title: "How to create components in React?",
    answer: `Components are the building blocks of creating User Interfaces(UI) in React. There are two possible ways to create a component.
...
2. **Class Components:** You can also use ES6 class to define a component. The above function component can be written as a class component:
  ...
  {
    slug: "core-when-to-use-a-class-component-over-a-function-component",
    num: 7,
    category: "core",
    title: "When to use a Class Component over a Function Component?",
    answer: `After the addition of Hooks(i.e. React 16.8 onwards) it is always recommended to use Function components over Class components in React. Because you could use state, lifecycle methods and other features that were only available in class component present in function component too.
...
\`\`\``,
  ...
  {
    slug: "core-what-are-pure-components",
    num: 8,
    category: "core",
...
**Note:** \`React.memo()\` is a higher-order component.`,
  ...
  {
    slug: "core-what-is-state-in-react",
    num: 9,
    category: "core",
    title: "What is state in React?",
    answer: `_State_ of a component is an object that holds some information that may change over the lifetime of the component. The important point is whenever the state object changes, the component re-renders. It is always recommended to make our state as simple as possible and minimize the number of stateful components.
...
State is similar to props, but it is private and fully controlled by the component ,i.e., it is not accessible to any other component till the owner component decides to pass it.`,
  ...
  {
    slug: "core-what-are-props-in-react",
    num: 10,
    category: "core",
    title: "What are props in React?",
    answer: `_Props_ are inputs to components. They are single values or objects containing a set of values that are passed to components on creation similar to HTML-tag attributes. Here, the data is passed down from a parent component to a child component.
...
\`\`\`
  ...
  {
    slug: "core-what-is-the-difference-between-state-and-props",
    num: 11,
    category: "core",
    title: "What is the difference between state and props?",
    answer: `In React, both **state** and **props** are plain JavaScript objects, but they serve different purposes and have distinct behaviors:
...
---`,
  ...
  {
    slug: "core-what-is-the-difference-between-html-and-react-event-handling",
    num: 12,
    category: "core",
...
3. In HTML, you need to invoke the function by appending \`()\`
  ...
  {
    slug: "core-what-are-synthetic-events-in-react",
    num: 13,
    category: "core",
...
\`\`\``,
  ...
  {
    slug: "core-what-is-key-prop-and-what-is-the-benefit-of-using-it-in-arrays-of-elements",
    num: 15,
    category: "core",
    title: "What is \"key\" prop and what is the benefit of using it in arrays of elements?",
    answer: `A \`key\` is a special attribute you **should** include when mapping over arrays to render data. _Key_ prop helps React identify which items have changed, are added, or are removed.
...
5. Don't generate the key on the fly something like \`key={Math.random()}\`. Because the keys will never match up between re-renders and DOM created everytime.`,
  ...
  {
    slug: "core-what-is-virtual-dom",
    num: 16,
    category: "core",
    title: "What is Virtual DOM?",
    answer: `The _Virtual DOM_ (VDOM) is a lightweight, in-memory representation of _Real DOM_ used by libraries like React to optimize UI rendering. The representation of a UI is kept in memory and synced with the "real" DOM. It's a step that happens between the render function being called and the displaying of elements on the screen. This entire process is called _reconciliation_.`,
  },
  {
    slug: "core-how-virtual-dom-works",
    num: 17,
    category: "core",
    title: "How Virtual DOM works?",
    answer: `The _Virtual DOM_ works in five simple steps.
...
**5. Efficient DOM Updates**  
  ...
  {
    slug: "core-what-is-the-difference-between-shadow-dom-and-virtual-dom",
    num: 18,
    category: "core",
    title: "What is the difference between Shadow DOM and Virtual DOM?",
    answer: `The _Shadow DOM_ is a browser technology designed primarily for scoping variables and CSS in _web components_. The _Virtual DOM_ is a concept implemented by libraries in JavaScript on top of browser APIs.
...
| Use Case | Web Components, scoped styling | UI diffing and minimal DOM updates |`,
  ...
  {
    slug: "core-what-is-the-main-goal-of-react-fiber",
    num: 20,
    category: "core",
    title: "What is the main goal of React Fiber?",
    answer: `The goal of _React Fiber_ is to increase its suitability for areas like animation, layout, and gestures. Its headline feature is **incremental rendering**: the ability to split rendering work into chunks and spread it out over multiple frames.
...
*   **Improved DevTools** – Enables better debugging and performance tracking.`,
  ...
  {
    slug: "core-what-are-controlled-components",
    num: 21,
    category: "core",
    title: "What are controlled components?",
    answer: `A **controlled component** is a React component that **fully manages the form element's state**(e.g, elements like \`<input>\`, \`<textarea>\`, or \`<select>\`))  using React's internal state mechanism. i.e, The component does not manage its own internal state — instead, React acts as the single source of truth for form data.
...
**Note:** React re-renders the component every time the input value changes.
 ...
 return (
  ...
  {
    slug: "core-what-are-uncontrolled-components",
    num: 22,
    category: "core",
    title: "What are uncontrolled components?",
    answer: `The **Uncontrolled components** are form elements (like \`<input>\`, \`<textarea>\`, or \`<select>\`) that **manage their own state internally** via the **DOM**, rather than through React state.
...
\`\`\`
  ...
  {
    slug: "core-what-is-the-difference-between-createelement-and-cloneelement",
    num: 23,
    category: "core",
    title: "What is the difference between createElement and cloneElement?",
    answer: `Both \`React.createElement\` and \`React.cloneElement\` are used to work with React elements, but they serve different purposes.
...
\`\`\``,
  ...
  {
    slug: "core-what-is-lifting-state-up-in-react",
    num: 24,
    category: "core",
    title: "What is Lifting State Up in React?",
    answer: `When several components need to share the same changing data then it is recommended to _lift the shared state up_ to their closest common ancestor. That means if two child components share the same data from its parent, then move the state to parent instead of maintaining local state in both of the child components.`,
  },
  {
    slug: "core-what-are-higher-order-components",
    num: 25,
    category: "core",
    title: "What are Higher-Order Components?",
    answer: `A _higher-order component_ (_HOC_) is a function that takes a component and returns a new enhanced component with additional props, behavior, or data. It’s a design pattern based on React’s compositional nature, allowing you to reuse logic across multiple components without modifying their internals.
...
6. withTheme from styled components`,
  ...
  {
    slug: "core-what-is-children-prop",
    num: 26,
    category: "core",
    title: "What is children prop?",
    answer: `The \`children\` prop is a special prop in React used to pass elements between the opening and closing tags of a component. It is commonly used in layout and wrapper componnents. 
...
**Note:** There are several methods available in the legacy React API to work with this prop. These include \`React.Children.map\`, \`React.Children.forEach\`, \`React.Children.count\`, \`React.Children.only\`, \`React.Children.toArray\`.`,
  ...
  {
    slug: "core-how-to-write-comments-in-react",
    num: 27,
    category: "core",
    title: "How to write comments in React?",
    answer: `The comments in React/JSX are similar to JavaScript Multiline comments but are wrapped in curly braces.
...
You can use \`//\` and \`/* */\` in JS logic, hooks, and functions.`,
  ...
  {
    slug: "core-what-is-reconciliation",
    num: 28,
    category: "core",
...
Now React compares the Virtual DOM with Real DOM. It finds out the changed nodes and updates only the changed nodes in Real DOM leaving the rest nodes as it is. This process is called _Reconciliation_.`,
  ...
  {
    slug: "core-does-the-lazy-function-support-named-exports",
    num: 29,
    category: "core",
...
\`\`\``,
  ...
  {
    slug: "core-why-react-uses-classname-over-class-attribute",
    num: 30,
    category: "core",
...
3. Aligns with DOM APIs
  ...
  {
    slug: "core-what-are-fragments",
    num: 31,
    category: "core",
    title: "What are fragments?",
    answer: `It's a common pattern or practice in React for a component to return multiple elements. _Fragments_ let you group a list of children without adding extra nodes to the DOM.
...
\`\`\``,
  ...
  {
    slug: "core-why-fragments-are-better-than-container-divs",
    num: 32,
    category: "core",
    title: "Why fragments are better than container divs?",
    answer: `Below are the list of reasons to prefer fragments over container DOM elements,
...
3. The DOM Inspector is less cluttered.`,
  ...
  {
    slug: "core-what-are-portals-in-react",
    num: 33,
    category: "core",
    title: "What are portals in React?",
    answer: `A Portal is a React feature that enables rendering children into a DOM node that exists outside the parent component's DOM hierarchy, while still preserving the React component hierarchy. Portals help avoid CSS stacking issues—for example, elements with position: fixed may not behave as expected inside a parent with transform. Portals solve this by rendering content (like modals or tooltips) outside such constrained DOM contexts.
...
The above code will render the modal content into the body element in the HTML, not inside the component's usual location.`,
  ...
  {
    slug: "core-what-are-stateless-components",
    num: 34,
    category: "core",
  ...
  {
    slug: "core-what-are-stateful-components",
    num: 35,
    category: "core",
    title: "What are stateful components?",
    answer: `If the behaviour of a component is dependent on the _state_ of the component then it can be termed as stateful component. These _stateful components_ are either function components with hooks or _class components_.
...
\`\`\`
  ...
  {
    slug: "core-how-to-apply-validation-on-props-in-react",
    num: 36,
    category: "core",
    title: "How to apply validation on props in React?",
    answer: `When the application is running in _development mode_, React will automatically check all props that we set on components to make sure they have _correct type_. If the type is incorrect, React will generate warning messages in the console. It's disabled in _production mode_ due to performance impact. The mandatory props are defined with \`isRequired\`.
...
\`\`\``,
  ...
  {
    slug: "core-what-are-the-advantages-of-react",
    num: 37,
    category: "core",
    title: "What are the advantages of React?",
    answer: `Below are the list of main advantages of React,
...
5. Easy to write unit and integration tests with tools such as Jest.`,
  ...
  {
    slug: "core-what-are-the-limitations-of-react",
    num: 38,
    category: "core",
    title: "What are the limitations of React?",
    answer: `Apart from the advantages, there are few limitations of React too,
...
5. Too many smaller components leading to over engineering or boilerplate.`,
  ...
  {
    slug: "core-what-are-the-recommended-ways-for-static-type-checking",
    num: 39,
    category: "core",
    title: "What are the recommended ways for static type checking?",
    answer: `Normally we use _PropTypes library_ (\`React.PropTypes\` moved to a \`prop-types\` package since React v15.5) for _type checking_ in the React applications. For large code bases, it is recommended to use _static type checkers_ such as Flow or TypeScript, that perform type checking at compile time and provide auto-completion features.`,
  },
  {
    slug: "core-what-is-the-use-of-react-dom-package",
    num: 40,
    category: "core",
    title: "What is the use of `react-dom` package?",
    answer: `The \`react-dom\` package provides _DOM-specific methods_ that can be used at the top level of your app. Most of the components are not required to use this module. Some of the methods of this package are:
...
5. \`createPortal()\``,
  ...
  {
    slug: "core-what-is-reactdomserver",
    num: 41,
    category: "core",
    title: "What is ReactDOMServer?",
    answer: `The \`ReactDOMServer\` object enables you to render components to static markup (typically used on node server). This object is mainly used for _server-side rendering_ (SSR). The following methods can be used in both the server and browser environments:
...
\`\`\``,
  ...
  {
    slug: "core-how-to-use-innerhtml-in-react",
    num: 42,
    category: "core",
    title: "How to use innerHTML in React?",
    answer: `The \`dangerouslySetInnerHTML\` attribute is React's replacement for using \`innerHTML\` in the browser DOM. Just like \`innerHTML\`, it is risky to use this attribute considering cross-site scripting (XSS) attacks. You just need to pass a \`__html\` object as key and HTML text as value.
...
\`\`\``,
  ...
  {
    slug: "core-how-to-use-styles-in-react",
    num: 43,
    category: "core",
    title: "How to use styles in React?",
    answer: `The \`style\` attribute accepts a JavaScript object with camelCased properties rather than a CSS string. This is consistent with the DOM style JavaScript property, is more efficient, and prevents XSS security holes.
...
Style keys are camelCased in order to be consistent with accessing the properties on DOM nodes in JavaScript (e.g. \`node.style.backgroundImage\`).`,
  ...
  {
    slug: "core-how-events-are-different-in-react",
    num: 44,
    category: "core",
    title: "How events are different in React?",
    answer: `Handling events in React elements has some syntactic differences:

1. React event handlers are named using camelCase, rather than lowercase.
2. With JSX you pass a function as the event handler, rather than a string.`,
  },
  {
    slug: "core-what-is-the-impact-of-indexes-as-keys",
    num: 45,
    category: "core",
    title: "What is the impact of indexes as keys?",
    answer: `Keys should be stable, predictable, and unique so that React can keep track of elements.
...
**Note:** If you don't specify \`key\` prop at all, React will use index as a key's value while iterating over an array of data.`,
  ...
  {
    slug: "core-how-do-you-conditionally-render-components",
    num: 46,
    category: "core",
    title: "How do you conditionally render components?",
    answer: `In some cases you want to render different components depending on some state. JSX does not render \`false\` or \`undefined\`, so you can use conditional _short-circuiting_ to render a given part of your component only if a certain condition is true.
...
\`\`\``,
  ...
  {
    slug: "core-why-we-need-to-be-careful-when-spreading-props-on-dom-elements",
    num: 47,
    category: "core",
    title: "Why we need to be careful when spreading props on DOM elements?",
    answer: `When we _spread props_ we run into the risk of adding unknown HTML attributes, which is a bad practice. Instead we can use prop destructuring with \`...rest\` operator, so it will add only required props.
...
\`\`\``,
  ...
  {
    slug: "core-how-do-you-memoize-a-component",
    num: 48,
    category: "core",
    title: "How do you memoize a component?",
    answer: `There are memoize libraries available which can be used on function components.
...
\`\`\``,
  ...
  {
    slug: "core-how-you-implement-server-side-rendering-or-ssr",
    num: 49,
    category: "core",
    title: "How you implement Server Side Rendering or SSR?",
    answer: `React is already equipped to handle rendering on Node servers. A special version of the DOM renderer is available, which follows the same pattern as on the client side.
...
This method will output the regular HTML as a string, which can be then placed inside a page body as part of the server response. On the client side, React detects the pre-rendered content and seamlessly picks up where it left off.`,
  ...
  {
    slug: "core-how-to-enable-production-mode-in-react",
    num: 50,
    category: "core",
  ...
  {
    slug: "core-do-hooks-replace-render-props-and-higher-order-components",
    num: 51,
    category: "core",
  ...
  {
    slug: "core-what-is-a-switching-component",
    num: 52,
    category: "core",
    title: "What is a switching component?",
    answer: `A _switching component_ is a component that renders one of many components. We need to use object to map prop values to components.
...
\`\`\``,
  ...
  {
    slug: "core-what-are-react-mixins",
    num: 53,
    category: "core",
    title: "What are React Mixins?",
    answer: `_Mixins_ are a way to totally separate components to have a common functionality. Mixins **should not be used** and can be replaced with _higher-order components_ or _decorators_.
...
\`\`\`
 ...
 <!-- TODO: mixins are deprecated -->`,
  ...
  {
    slug: "core-what-are-the-pointer-events-supported-in-react",
    num: 54,
    category: "core",
    title: "What are the Pointer Events supported in React?",
    answer: `_Pointer Events_ provide a unified way of handling all input events. In the old days we had a mouse and respective event listeners to handle them but nowadays we have many devices which don't correlate to having a mouse, like phones with touch surface or pens. We need to remember that these events will only work in browsers that support the _Pointer Events_ specification.
...
10. \`onPointerOut\``,
  ...
  {
    slug: "core-why-should-component-names-start-with-capital-letter",
    num: 55,
    category: "core",
    title: "Why should component names start with capital letter?",
    answer: `If you are rendering your component using JSX, the name of that component has to begin with a capital letter otherwise React will throw an error as an unrecognized tag. This convention is because only HTML elements and SVG tags can begin with a lowercase letter.
...
\`\`\``,
  ...
  {
    slug: "core-are-custom-dom-attributes-supported-in-react-v16",
    num: 56,
    category: "core",
    title: "Are custom DOM attributes supported in React v16?",
    answer: `Yes. In the past, React used to ignore unknown DOM attributes. If you wrote JSX with an attribute that React doesn't recognize, React would just skip it.
...
This is useful for supplying browser-specific non-standard attributes, trying new DOM APIs, and integrating with opinionated third-party libraries.`,
  ...
  {
    slug: "core-how-to-loop-inside-jsx",
    num: 57,
    category: "core",
    title: "How to loop inside JSX?",
    answer: `You can simply use \`Array.prototype.map\` with ES6 _arrow function_ syntax.
...
This is because JSX tags are transpiled into _function calls_, and you can't use statements inside expressions. This may change thanks to \`do\` expressions which are _stage 1 proposal_.`,
  ...
  {
    slug: "core-how-do-you-access-props-in-attribute-quotes",
    num: 58,
    category: "core",
    title: "How do you access props in attribute quotes?",
    answer: `React (or JSX) doesn't support variable interpolation inside an attribute value. The below representation won't work:
...
\`\`\``,
  ...
  {
    slug: "core-what-is-react-proptype-array-with-shape",
    num: 59,
    category: "core",
    title: "What is React proptype array with shape?",
    answer: `If you want to pass an array of objects to a component with a particular shape then use \`React.PropTypes.shape()\` as an argument to \`React.PropTypes.arrayOf()\`.
...
\`\`\``,
  ...
  {
    slug: "core-how-to-conditionally-apply-class-attributes",
    num: 60,
    category: "core",
    title: "How to conditionally apply class attributes?",
    answer: `You shouldn't use curly braces inside quotes because it is going to be evaluated as a string.
...
\`\`\``,
  ...
  {
    slug: "core-what-is-the-difference-between-react-and-reactdom",
    num: 61,
    category: "core",
  ...
  {
    slug: "core-why-reactdom-is-separated-from-react",
    num: 62,
    category: "core",
...
To build more environments that React can render to, React team planned to split the main React package into two: \`react\` and \`react-dom\`. This paves the way to writing components that can be shared between the web version of React and React Native.`,
  ...
  {
    slug: "core-how-to-use-react-label-element",
    num: 63,
    category: "core",
    title: "How to use React label element?",
    answer: `If you try to render a \`<label>\` element bound to a text input using the standard \`for\` attribute, then it produces HTML missing that attribute and prints a warning to the console.
...
\`\`\``,
  ...
  {
    slug: "core-how-to-combine-multiple-inline-style-objects",
    num: 64,
    category: "core",
    title: "How to combine multiple inline style objects?",
    answer: `You can use _spread operator_ in regular React:
...
\`\`\``,
  ...
  {
    slug: "core-how-to-re-render-the-view-when-the-browser-is-resized",
    num: 65,
    category: "core",
    title: "How to re-render the view when the browser is resized?",
    answer: `You can use the \`useState\` hook to manage the width and height state variables, and the \`useEffect\` hook to add and remove the \`resize\` event listener. The \`[]\` dependency array passed to useEffect ensures that the effect only runs once (on mount) and not on every re-render.
...
\`\`\`
  ...
  {
    slug: "core-how-to-pretty-print-json-with-react",
    num: 66,
    category: "core",
    title: "How to pretty print JSON with React?",
    answer: `We can use \`<pre>\` tag so that the formatting of the \`JSON.stringify()\` is retained:
...
\`\`\`
  ...
  {
    slug: "core-why-can-t-you-update-props-in-react",
    num: 67,
    category: "core",
    title: "Why can't you update props in React?",
    answer: `The React philosophy is that props should be _immutable_(read only) and _top-down_. This means that a parent can send any prop values to a child, but the child can't modify received props.`,
  },
  {
    slug: "core-how-to-focus-an-input-element-on-page-load",
    num: 68,
    category: "core",
    title: "How to focus an input element on page load?",
    answer: `You need to use \`useEffect\` hook to set focus on input field during page load time for functional component.
...
\`\`\`
  ...
  {
    slug: "core-how-can-we-find-the-version-of-react-at-runtime-in-the-browser",
    num: 69,
    category: "core",
...
\`\`\``,
  ...
  {
    slug: "core-how-to-add-google-analytics-for-react-router",
    num: 70,
    category: "core",
    title: "How to add Google Analytics for React Router?",
    answer: `Add a listener on the \`history\` object to record each page view:
...
\`\`\``,
  ...
  {
    slug: "core-how-do-you-apply-vendor-prefixes-to-inline-styles-in-react",
    num: 71,
    category: "core",
    title: "How do you apply vendor prefixes to inline styles in React?",
    answer: `React _does not_ apply _vendor prefixes_ automatically. You need to add vendor prefixes manually.
...
\`\`\``,
  ...
  {
    slug: "core-how-to-import-and-export-components-using-react-and-es6",
    num: 72,
    category: "core",
    title: "How to import and export components using React and ES6?",
    answer: `You should use default for exporting the components
...
\`\`\``,
  ...
  {
    slug: "core-what-are-the-exceptions-on-react-component-naming",
    num: 73,
    category: "core",
...
\`\`\``,
  ...
  {
    slug: "core-is-it-possible-to-use-async-await-in-plain-react",
    num: 74,
    category: "core",
    title: "Is it possible to use async/await in plain React?",
    answer: `Yes, you can use \`async/await\` in plain React, as long as your JavaScript environment supports ES2017+. Nowadays most modern browsers and build tools support ES2017+ version. If you're using **Create React App**, **Next.js**, **Remix**, or any modern React setup, \`async/await\` is supported out of the box through **Babel**.
...
But If you're not using a bundler like **Webpack or Babel**, you will need _Babel_ and [transform-async-to-generator](https://babeljs.io/docs/en/babel-plugin-transform-async-to-generator) plugin. However, React Native ships with Babel and a set of transforms.`,
  ...
  {
    slug: "core-what-are-the-common-folder-structures-for-react",
    num: 75,
    category: "core",
    title: "What are the common folder structures for React?",
    answer: `There are two common practices for React project file structure.
 ...
 2.  **Grouping by file type:**
  ...
  {
    slug: "core-what-are-the-popular-packages-for-animation",
    num: 76,
    category: "core",
    title: "What are the popular packages for animation?",
    answer: `_React Transition Group_ and _React Motion_ are popular animation packages in React ecosystem.`,
  },
  {
    slug: "core-what-is-the-benefit-of-styles-modules",
    num: 77,
    category: "core",
    title: "What is the benefit of styles modules?",
    answer: `It is recommended to avoid hard coding style values in components. Any values that are likely to be used across different UI components should be extracted into their own modules.
...
\`\`\``,
  ...
  {
    slug: "core-what-are-the-popular-react-specific-linters",
    num: 78,
    category: "core",
...
Another popular plugin is \`eslint-plugin-jsx-a11y\`, which will help fix common issues with accessibility. As JSX offers slightly different syntax to regular HTML, issues with \`alt\` text and \`tabindex\`, for example, will not be picked up by regular plugins.`,
  ...
  {
    slug: "router-what-is-react-router",
    num: 79,
    category: "router",
    title: "What is React Router?",
    answer: `React Router is a powerful routing library built on top of React that helps you add new screens and flows to your application incredibly quickly, all while keeping the URL in sync with what's being displayed on the page.`,
  },
  {
    slug: "router-how-react-router-is-different-from-history-library",
    num: 80,
    category: "router",
  ...
  {
    slug: "router-what-are-the-router-components-of-react-router-v6",
    num: 81,
    category: "router",
    title: "What are the `<Router>` components of React Router v6?",
    answer: `React Router v6 provides below 4 \`<Router>\` components:
...
The above components will create _browser_, _hash_, _memory_ and _static_ history instances. React Router v6 makes the properties and methods of the \`history\` instance associated with your router available through the context in the \`router\` object.`,
  ...
  {
    slug: "router-what-is-the-purpose-of-push-and-replace-methods-of-history",
    num: 82,
    category: "router",
    title: "What is the purpose of `push()` and `replace()` methods of `history`?",
    answer: `A history instance has two methods for navigation purpose.
...
If you think of the history as an array of visited locations, \`push()\` will add a new location to the array and \`replace()\` will replace the current location in the array with the new one.`,
  ...
  {
    slug: "router-how-do-you-programmatically-navigate-using-react-router-v4",
    num: 83,
    category: "router",
    title: "How do you programmatically navigate using React Router v4?",
    answer: `There are three different ways to achieve programmatic routing/navigation within components.
...
3.  **Using context:**
  ...
  {
    slug: "router-how-to-get-query-parameters-in-react-router-v4",
    num: 84,
    category: "router",
    title: "How to get query parameters in React Router v4?",
    answer: `The ability to parse query strings was taken out of React Router v4 because there have been user requests over the years to support different implementation. So the decision has been given to users to choose the implementation they like. The recommended approach is to use query strings library.
...
You should use a _polyfill_ for IE11.`,
  ...
  {
    slug: "router-why-you-get-router-may-have-only-one-child-element-warning",
    num: 85,
    category: "router",
...
\`\`\``,
  ...
  {
    slug: "router-how-to-pass-params-to-history-push-method-in-react-router-v4",
    num: 86,
    category: "router",
    title: "How to pass params to `history.push` method in React Router v4?",
    answer: `While navigating you can pass props to the \`history\` object:
...
The \`search\` property is used to pass query params in \`push()\` method.`,
  ...
  {
    slug: "router-how-to-implement-default-or-notfound-page",
    num: 87,
    category: "router",
    title: "How to implement _default_ or _NotFound_ page?",
    answer: `A \`<Switch>\` renders the first child \`<Route>\` that matches. A \`<Route>\` with no path always matches. So you just need to simply drop path attribute as below
...
\`\`\``,
  ...
  {
    slug: "router-how-to-get-history-on-react-router-v4",
    num: 88,
    category: "router",
    title: "How to get history on React Router v4?",
    answer: `Below are the list of steps to get history object on React Router v4,
...
3.  You can also use push method of \`history\` object similar to built-in history object:
  ...
  {
    slug: "router-how-to-perform-automatic-redirect-after-login",
    num: 89,
    category: "router",
    title: "How to perform automatic redirect after login?",
    answer: `The \`react-router\` package provides \`<Redirect>\` component in React Router. Rendering a \`<Redirect>\` will navigate to a new location. Like server-side redirects, the new location will override the current location in the history stack.
...
\`\`\`
  ...
  {
    slug: "i18n-what-is-react-intl",
    num: 90,
    category: "i18n",
    title: "What is React Intl?",
    answer: `The _React Intl_ library makes internationalization in React straightforward, with off-the-shelf components and an API that can handle everything from formatting strings, dates, and numbers, to pluralization. React Intl is part of _FormatJS_ which provides bindings to React via its components and API.`,
  },
  {
    slug: "i18n-what-are-the-main-features-of-react-intl",
    num: 91,
    category: "i18n",
...
7.  Built on standards.`,
  ...
  {
    slug: "i18n-what-are-the-two-ways-of-formatting-in-react-intl",
    num: 92,
    category: "i18n",
    title: "What are the two ways of formatting in React Intl?",
    answer: `The library provides two ways to format strings, numbers, and dates:
...
2.  **Using an API:**
  ...
  {
    slug: "i18n-how-to-use-formattedmessage-as-placeholder-using-react-intl",
    num: 93,
    category: "i18n",
...
\`\`\``,
  ...
  {
    slug: "i18n-how-to-access-current-locale-with-react-intl",
    num: 94,
    category: "i18n",
    title: "How to access current locale with React Intl?",
    answer: `You can get the current locale in any component of your application using \`injectIntl()\`:
...
\`\`\``,
  ...
  {
    slug: "i18n-how-to-format-date-using-react-intl",
    num: 95,
    category: "i18n",
    title: "How to format date using React Intl?",
    answer: `The \`injectIntl()\` higher-order component will give you access to the \`formatDate()\` method via the props in your component. The method is used internally by instances of \`FormattedDate\` and it returns the string representation of the formatted date.
 ...
 \`\`\``,
  ...
  {
    slug: "testing-what-is-shallow-renderer-in-react-testing",
    num: 96,
    category: "testing",
    title: "What is Shallow Renderer in React testing?",
    answer: `_Shallow rendering_ is useful for writing unit test cases in React. It lets you render a component _one level deep_ and assert facts about what its render method returns, without worrying about the behavior of child components, which are not instantiated or rendered.
...
\`\`\``,
  ...
  {
    slug: "testing-what-is-testrenderer-package-in-react",
    num: 97,
    category: "testing",
...
\`\`\``,
  ...
  {
    slug: "testing-what-is-the-purpose-of-reacttestutils-package",
    num: 98,
    category: "testing",
    title: "What is the purpose of ReactTestUtils package?",
    answer: `_ReactTestUtils_ are provided in the \`with-addons\` package and allow you to perform actions against a simulated DOM for the purpose of unit testing.`,
  },
  {
    slug: "testing-what-is-jest",
    num: 99,
    category: "testing",
    title: "What is Jest?",
    answer: `_Jest_ is a JavaScript unit testing framework created by Facebook based on Jasmine and provides automated mock creation and a \`jsdom\` environment. It's often used for testing components.`,
  },
  {
    slug: "testing-what-are-the-advantages-of-jest-over-jasmine",
    num: 100,
    category: "testing",
    title: "What are the advantages of Jest over Jasmine?",
    answer: `There are couple of advantages compared to Jasmine:
 ...
 - Runs tests in parallel processes so that they finish sooner.`,
  ...
  {
    slug: "testing-give-a-simple-example-of-jest-test-case",
    num: 101,
    category: "testing",
    title: "Give a simple example of Jest test case",
    answer: `Let's write a test for a function that adds two numbers in \`sum.js\` file:
 ...
 \`\`\``,
  ...
  {
    slug: "redux-what-is-redux",
    num: 103,
    category: "redux",
    title: "What is Redux?",
    answer: `Redux is a predictable state container for JavaScript applications, most commonly used with React. It helps you manage and centralize your application’s state in a single source of truth, enabling easier debugging, testing, and maintenance—especially in large or complex applications. Redux core is tiny library(about 2.5kB gzipped) and has no dependencies.`,
  },
  {
    slug: "redux-what-are-the-core-principles-of-redux",
    num: 104,
    category: "redux",
 ...
 3. **Changes are made with pure functions(Reducers):** To specify how the state tree is transformed by actions, you write reducers. Reducers are just pure functions that take the previous state and an action as parameters, and return the next state.
  ...
  {
    slug: "redux-what-are-the-downsides-of-redux-compared-to-flux",
    num: 105,
    category: "redux",
    title: "What are the downsides of Redux compared to Flux?",
    answer: `While Redux offers a powerful and predictable state management solution, it comes with a few trade-offs when compared to Flux. These include:
 ...
 3.  **Limited static type integration**  
  ...
  {
    slug: "redux-what-is-the-difference-between-mapstatetoprops-and-mapdispatchtoprops",
    num: 106,
    category: "redux",
 ...
 \`\`\``,
  ...
  {
    slug: "redux-can-i-dispatch-an-action-in-reducer",
    num: 107,
    category: "redux",
    title: "Can I dispatch an action in reducer?",
    answer: `Dispatching an action within a reducer is an **anti-pattern**. Your reducer should be _without side effects_, simply digesting the action payload and returning a new state object. Adding listeners and dispatching actions within the reducer can lead to chained actions and other side effects.`,
  },
  {
    slug: "redux-how-to-access-redux-store-outside-a-component",
    num: 108,
    category: "redux",
    title: "How to access Redux store outside a component?",
    answer: `You just need to export the store from the module where it created with \`createStore()\`. Also, it shouldn't pollute the global window object.
 ...
 \`\`\``,
  ...
  {
    slug: "redux-what-are-the-drawbacks-of-mvw-pattern",
    num: 109,
    category: "redux",
    title: "What are the drawbacks of MVW pattern?",
    answer: `1. DOM manipulation is very expensive which causes applications to behave slow and inefficient.
 2. Due to circular dependencies, a complicated model was created around models and views.
 3. Lot of data changes happens for collaborative applications(like Google Docs).
 4. No way to do undo (travel back in time) easily without adding so much extra code.`,
  },
  {
    slug: "redux-are-there-any-similarities-between-redux-and-rxjs",
    num: 110,
    category: "redux",
 ...
 Redux is a tool for managing state throughout the application. It is usually used as an architecture for UIs. Think of it as an alternative to (half of) Angular. RxJS is a reactive programming library. It is usually used as a tool to accomplish asynchronous tasks in JavaScript. Think of it as an alternative to Promises. Redux uses the Reactive paradigm because the Store is reactive. The Store observes actions from a distance, and changes itself. RxJS also uses the Reactive paradigm, but instead of being an architecture, it gives you basic building blocks, Observables, to accomplish this pattern.`,
  ...
  {
    slug: "redux-how-to-reset-state-in-redux",
    num: 111,
    category: "redux",
    title: "How to reset state in Redux?",
    answer: `You need to write a _root reducer_ in your application which delegate handling the action to the reducer generated by \`combineReducers()\`.
 ...
 \`\`\``,
  ...
  {
    slug: "redux-what-is-the-difference-between-react-context-and-react-redux",
    num: 112,
    category: "redux",
    title: "What is the difference between React context and React Redux?",
    answer: `You can use **Context** in your application directly and is going to be great for passing down data to deeply nested components which what it was designed for.

 Whereas **Redux** is much more powerful and provides a large number of features that the Context API doesn't provide. Also, React Redux uses context internally but it doesn't expose this fact in the public API.`,
  },
  {
    slug: "redux-why-are-redux-state-functions-called-reducers",
    num: 113,
    category: "redux",
  ...
  {
    slug: "redux-how-to-make-ajax-request-in-redux",
    num: 114,
    category: "redux",
 ...
 \`\`\``,
  ...
  {
    slug: "redux-should-i-keep-all-component-s-state-in-redux-store",
    num: 115,
    category: "redux",
  ...
  {
    slug: "redux-what-is-the-proper-way-to-access-redux-store",
    num: 116,
    category: "redux",
 ...
 \`\`\``,
  ...
  {
    slug: "redux-what-is-the-difference-between-component-and-container-in-react-redux",
    num: 117,
    category: "redux",
 ...
 **Container** is an informal term for a component that is connected to a Redux store. Containers _subscribe_ to Redux state updates and _dispatch_ actions, and they usually don't render DOM elements; they delegate rendering to presentational child components.`,
  ...
  {
    slug: "redux-what-is-the-purpose-of-the-constants-in-redux",
    num: 118,
    category: "redux",
    title: "What is the purpose of the constants in Redux?",
    answer: `Constants allows you to easily find all usages of that specific functionality across the project when you use an IDE. It also prevents you from introducing silly bugs caused by typos – in which case, you will get a \`ReferenceError\` immediately.
 ...
 2. **In reducers:**
  ...
  {
    slug: "redux-what-are-the-different-ways-to-write-mapdispatchtoprops",
    num: 119,
    category: "redux",
    title: "What are the different ways to write `mapDispatchToProps()`?",
    answer: `There are a few ways of binding _action creators_ to \`dispatch()\` in \`mapDispatchToProps()\`.
 ...
 The third option is just a shorthand for the first one.`,
  ...
  {
    slug: "redux-what-is-the-use-of-the-ownprops-parameter-in-mapstatetoprops-and-mapdispatchtoprops",
    num: 120,
    category: "redux",
    title: "What is the use of the `ownProps` parameter in `mapStateToProps()` and `mapDispatchToProps()`?",
    answer: `If the \`ownProps\` parameter is specified, React Redux will pass the props that were passed to the component into your _connect_ functions. So, if you use a connected component:
 ...
 You can use this object to decide what to return from those functions.`,
  ...
  {
    slug: "redux-how-to-structure-redux-top-level-directories",
    num: 121,
    category: "redux",
 ...
 This structure works well for small and medium size apps.`,
  ...
  {
    slug: "redux-what-is-redux-saga",
    num: 122,
    category: "redux",
    title: "What is redux-saga?",
    answer: `\`redux-saga\` is a library that aims to make side effects (asynchronous things like data fetching and impure things like accessing the browser cache) in React/Redux applications easier and better.
 ...
 \`\`\``,
  ...
  {
    slug: "redux-what-is-redux-thunk",
    num: 125,
    category: "redux",
    title: "What is Redux Thunk?",
    answer: `_Redux Thunk_ middleware allows you to write action creators that return a function instead of an action. The thunk can be used to delay the dispatch of an action, or to dispatch only if a certain condition is met. The inner function receives the store methods \`dispatch()\` and \`getState()\` as parameters.`,
  },
  {
    slug: "redux-what-are-the-differences-between-redux-saga-and-redux-thunk",
    num: 126,
    category: "redux",
    title: "What are the differences between `redux-saga` and `redux-thunk`?",
    answer: `Both _Redux Thunk_ and _Redux Saga_ take care of dealing with side effects. In most of the scenarios, Thunk uses _Promises_ to deal with them, whereas Saga uses _Generators_. Thunk is simple to use and Promises are familiar to many developers, Sagas/Generators are more powerful but you will need to learn them. But both middleware can coexist, so you can start with Thunks and introduce Sagas when/if you need them.`,
  },
  {
    slug: "redux-what-is-redux-devtools",
    num: 127,
    category: "redux",
    title: "What is Redux DevTools?",
    answer: `_Redux DevTools_ is a live-editing time travel environment for Redux with hot reloading, action replay, and customizable UI. If you don't want to bother with installing Redux DevTools and integrating it into your project, consider using Redux DevTools Extension for Chrome and Firefox.`,
  },
  {
    slug: "redux-what-are-the-features-of-redux-devtools",
    num: 128,
    category: "redux",
 ...
 5. With \`persistState()\` store enhancer, you can persist debug sessions across page reloads.`,
  ...
  {
    slug: "redux-what-are-redux-selectors-and-why-use-them",
    num: 129,
    category: "redux",
    title: "What are Redux selectors and why use them?",
    answer: `_Selectors_ are functions that take Redux state as an argument and return some data to pass to the component.
 ...
 2. The selector is not recomputed unless one of its arguments changes`,
  ...
  {
    slug: "redux-what-is-redux-form",
    num: 130,
    category: "redux",
    title: "What is Redux Form?",
    answer: `_Redux Form_ works with React and Redux to enable a form in React to use Redux to store all of its state. Redux Form can be used with raw HTML5 inputs, but it also works very well with common UI frameworks like Material UI, React Widgets and React Bootstrap.`,
  },
  {
    slug: "redux-what-are-the-main-features-of-redux-form",
    num: 131,
    category: "redux",
    title: "What are the main features of Redux Form?",
    answer: `Some of the main features of Redux Form are:
 ...
 3. Formatting, parsing and normalization of field values.`,
  ...
  {
    slug: "redux-how-to-add-multiple-middlewares-to-redux",
    num: 132,
    category: "redux",
 ...
 \`\`\``,
  ...
  {
    slug: "redux-how-to-set-initial-state-in-redux",
    num: 133,
    category: "redux",
 ...
 \`\`\``,
  ...
  {
    slug: "redux-how-relay-is-different-from-redux",
    num: 134,
    category: "redux",
  ...
  {
    slug: "redux-what-is-an-action-in-redux",
    num: 135,
    category: "redux",
    title: "What is an action in Redux?",
    answer: `_Actions_ are plain JavaScript objects or payloads of information that send data from your application to your store. They are the only source of information for the store. Actions must have a type property that indicates the type of action being performed.
 ...
 \`\`\``,
  ...
  {
    slug: "native-what-is-the-difference-between-react-native-and-react",
    num: 136,
    category: "native",
    title: "What is the difference between React Native and React?",
    answer: `**React** is a JavaScript library, supporting both front end web and being run on the server, for building user interfaces and web applications.

 **React Native** is a mobile framework that compiles to native app components, allowing you to build native mobile applications (iOS, Android, and Windows) in JavaScript that allows you to use React to build your components, and implements React under the hood.`,
  },
  {
    slug: "native-how-to-test-react-native-apps",
    num: 137,
    category: "native",
    title: "How to test React Native apps?",
    answer: `React Native can be tested only in mobile simulators like iOS and Android. You can run the app in your mobile using expo app (https://expo.io) Where it syncs using QR code, your mobile and computer should be in same wireless network.`,
  },
  {
    slug: "native-how-to-do-logging-in-react-native",
    num: 138,
    category: "native",
    title: "How to do logging in React Native?",
    answer: `You can use \`console.log\`, \`console.warn\`, etc. As of React Native v0.29 you can simply run the following to see logs in the console:
 ...
 \`\`\``,
  ...
  {
    slug: "native-how-to-debug-your-react-native",
    num: 139,
    category: "native",
 ...
 5. You should now be able to debug as you normally would.`,
  ...
  {
    slug: "ecosystem-what-is-reselect-and-how-it-works",
    num: 140,
    category: "ecosystem",
    title: "What is reselect and how it works?",
    answer: `_Reselect_ is a **selector library** (for Redux) which uses _memoization_ concept. It was originally written to compute derived data from Redux-like applications state, but it can't be tied to any architecture or library.
 ...
 Reselect keeps a copy of the last inputs/outputs of the last call, and recomputes the result only if one of the inputs changes. If the same inputs are provided twice in a row, Reselect returns the cached output. It's memoization and cache are fully customizable.`,
  ...
  {
    slug: "ecosystem-what-is-flow",
    num: 141,
    category: "ecosystem",
    title: "What is Flow?",
    answer: `_Flow_ is a _static type checker_ designed to find type errors in JavaScript. Flow types can express much more fine-grained distinctions than traditional type systems. For example, Flow helps you catch errors involving \`null\`, unlike most type systems.`,
  },
  {
    slug: "ecosystem-what-is-the-difference-between-flow-and-proptypes",
    num: 142,
    category: "ecosystem",
    title: "What is the difference between Flow and PropTypes?",
    answer: `Flow is a _static analysis tool_ (static checker) which uses a superset of the language, allowing you to add type annotations to all of your code and catch an entire class of bugs at compile time.
 ...
 PropTypes is a _basic type checker_ (runtime checker) which has been patched onto React. It can't check anything other than the types of the props being passed to a given component. If you want more flexible typechecking for your entire project Flow/TypeScript are appropriate choices.`,
  ...
  {
    slug: "ecosystem-how-to-use-font-awesome-icons-in-react",
    num: 143,
    category: "ecosystem",
    title: "How to use Font Awesome icons in React?",
    answer: `The below steps followed to include Font Awesome in React:
 ...
 3. Add Font Awesome classes in \`className\`:
  ...
  {
    slug: "ecosystem-what-is-react-dev-tools",
    num: 144,
    category: "ecosystem",
    title: "What is React Dev Tools?",
    answer: `_React Developer Tools_ let you inspect the component hierarchy, including component props and state. It exists both as a browser extension (for Chrome and Firefox), and as a standalone app (works with other environments including Safari, IE, and React Native).
 ...
 3. **Standalone app** (Safari, React Native, etc)`,
  ...
  {
    slug: "ecosystem-why-is-devtools-not-loading-in-chrome-for-local-files",
    num: 145,
    category: "ecosystem",
    title: "Why is DevTools not loading in Chrome for local files?",
    answer: `If you opened a local HTML file in your browser (\`file://...\`) then you must first open _Chrome Extensions_ and check \`Allow access to file URLs\`.`,
  },
  {
    slug: "ecosystem-how-to-use-polymer-in-react",
    num: 146,
    category: "ecosystem",
    title: "How to use Polymer in React?",
    answer: `You need to follow below steps to use Polymer in React,
 ...
 3. Use that element in the JSX file:
  ...
  {
    slug: "ecosystem-what-are-the-advantages-of-react-over-vue-js",
    num: 147,
    category: "ecosystem",
...
**Note:** The above list of advantages are purely opinionated and it vary based on the professional experience. But they are helpful as base parameters.`,
  ...
  {
    slug: "ecosystem-what-is-the-difference-between-react-and-angular",
    num: 148,
    category: "ecosystem",
    title: "What is the difference between React and Angular?",
    answer: `Let's see the difference between React and Angular in a table format.
...
**Note:** The above list of differences are purely opinionated and it vary based on the professional experience. But they are helpful as base parameters.`,
  ...
  {
    slug: "ecosystem-why-react-tab-is-not-showing-up-in-devtools",
    num: 149,
    category: "ecosystem",
    title: "Why React tab is not showing up in DevTools?",
    answer: `When the page loads, _React DevTools_ sets a global named \`__REACT_DEVTOOLS_GLOBAL_HOOK__\`, then React communicates with that hook during initialization. If the website is not using React or if React fails to communicate with DevTools then it won't show up the tab.`,
  },
  {
    slug: "ecosystem-what-are-styled-components",
    num: 150,
    category: "ecosystem",
  ...
  {
    slug: "ecosystem-give-an-example-of-styled-components",
    num: 151,
    category: "ecosystem",
    title: "Give an example of Styled Components?",
    answer: `Lets create \`<Title>\` and \`<Wrapper>\` components with specific styles for each.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-are-the-main-features-of-reselect-library",
    num: 153,
    category: "misc",
...
154. #### Give an example of Reselect usage?
 ...
 \`\`\``,
  ...
  {
    slug: "misc-can-redux-only-be-used-with-react",
    num: 155,
    category: "misc",
  ...
  {
    slug: "misc-do-you-need-to-have-a-particular-build-tool-to-use-redux",
    num: 156,
    category: "misc",
  ...
  {
    slug: "misc-how-redux-form-initialvalues-get-updated-from-state",
    num: 157,
    category: "misc",
    title: "How Redux Form `initialValues` get updated from state?",
    answer: `You need to add \`enableReinitialize : true\` setting.
 ...
 If your \`initialValues\` prop gets updated, your form will update too.`,
  ...
  {
    slug: "misc-how-react-proptypes-allow-different-types-for-one-prop",
    num: 158,
    category: "misc",
    title: "How React PropTypes allow different types for one prop?",
    answer: `You can use \`oneOfType()\` method of \`PropTypes\`.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-can-i-import-an-svg-file-as-react-component",
    num: 159,
    category: "misc",
    title: "Can I import an SVG file as react component?",
    answer: `You can import SVG directly as component instead of loading it as a file. This feature is available with \`react-scripts@2.0.0\` and higher.
 ...
 **Note**: Don't forget about the curly braces in the import.`,
  ...
  {
    slug: "misc-what-is-render-hijacking-in-react",
    num: 160,
    category: "misc",
  ...
  {
    slug: "misc-how-to-pass-numbers-to-react-component",
    num: 161,
    category: "misc",
    title: "How to pass numbers to React component?",
    answer: `We can pass \`numbers\` as \`props\` to React component using curly braces \`{}\` where as \`strings\` in double quotes \`""\` or single quotes \`''\`
 ...
 \`\`\``,
  ...
  {
    slug: "misc-do-i-need-to-keep-all-my-state-into-redux-should-i-ever-use-react-internal-state",
    num: 162,
    category: "misc",
 ...
 5. Do you want to cache the data (i.e, use what's in state if it's already there instead of re-requesting it)?`,
  ...
  {
    slug: "misc-what-is-the-purpose-of-registerserviceworker-in-react",
    num: 163,
    category: "misc",
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-react-memo-function",
    num: 164,
    category: "misc",
    title: "What is React memo function?",
    answer: `Class components can be restricted from re-rendering when their input props are the same using **PureComponent or shouldComponentUpdate**. Now you can do the same with function components by wrapping them in **React.memo**.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-react-lazy-function",
    num: 165,
    category: "misc",
    title: "What is React lazy function?",
    answer: `The \`React.lazy\` function lets you render a dynamic import as a regular component. It will automatically load the bundle containing the \`OtherComponent\` when the component gets rendered. This must return a Promise which resolves to a module with a default export containing a React component.
 ...
 **Note:**
 \`React.lazy\` and \`Suspense\` is not yet available for server-side rendering. If you want to do code-splitting in a server rendered app, we still recommend React Loadable.`,
  ...
  {
    slug: "misc-how-to-prevent-unnecessary-updates-using-setstate",
    num: 166,
    category: "misc",
    title: "How to prevent unnecessary updates using setState?",
    answer: `You can compare the current value of the state with an existing state value and decide whether to rerender the page or not. If the values are the same then you need to return **null** to stop re-rendering otherwise return the latest state value.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-how-do-you-render-array-strings-and-numbers-in-react-16-version",
    num: 167,
    category: "misc",
    title: "How do you render Array, Strings and Numbers in React 16 Version?",
    answer: `**Arrays**: Unlike older releases, you don't need to make sure **render** method return a single element in React16. You are able to return multiple sibling elements without a wrapping element by returning an array.
 ...
 **Strings and Numbers:** You can also return string and number type from the render method.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-are-hooks",
    num: 168,
    category: "misc",
    title: "What are hooks?",
    answer: `Hooks is a special JavaScript function that allows you use state and other React features without writing a class. This pattern has been introduced as a new feature in React 16.8 and helped to isolate the stateful logic from the components.
 ...
 **Note:** Hooks can be used inside an existing function component without rewriting the component.`,
  ...
  {
    slug: "misc-what-rules-need-to-be-followed-for-hooks",
    num: 169,
    category: "misc",
    title: "What rules need to be followed for hooks?",
    answer: `You need to follow two rules in order to use hooks,
 ...
 **Incorrect usage:**:
 ...
 In the above incorrect usage example, both \`useState\` and \`useEffect\` are used in non-React functions(\`normalFunction\` and \`fetchData\`), which is not allowed.`,
  ...
  {
    slug: "misc-how-to-ensure-hooks-followed-the-rules-in-your-project",
    num: 170,
    category: "misc",
    title: "How to ensure hooks followed the rules in your project?",
    answer: `React team released an ESLint plugin called **eslint-plugin-react-hooks** that enforces Hook's two rules. It is part of Hooks API. You can add this plugin to your project using the below command,
  ...
  {
    slug: "misc-what-are-the-differences-between-flux-and-redux",
    num: 171,
    category: "misc",
    title: "What are the differences between Flux and Redux?",
    answer: `Below are the major differences between Flux and Redux
 ...
 | React components subscribe to the store        | Container components uses connect function |`,
  ...
  {
    slug: "misc-what-are-the-benefits-of-react-router-v4",
    num: 172,
    category: "misc",
    title: "What are the benefits of React Router V4?",
    answer: `Below are the main benefits of React Router V4 module,
 ...
 3. The application size is reduced by adding only the specific router module(Web, core, or native)`,
  ...
  {
    slug: "misc-can-you-describe-about-componentdidcatch-lifecycle-method-signature",
    num: 173,
    category: "misc",
    title: "Can you describe about componentDidCatch lifecycle method signature?",
    answer: `The **componentDidCatch** lifecycle method is invoked after an error has been thrown by a descendant component. The method receives two parameters,
 ...
 \`\`\``,
  ...
  {
    slug: "misc-in-which-scenarios-do-error-boundaries-not-catch-errors",
    num: 174,
    category: "misc",
    title: "In which scenarios do error boundaries not catch errors?",
    answer: `Below are the cases in which error boundaries don't work,
 ...
 4. When errors thrown in the error boundary code itself`,
  ...
  {
    slug: "misc-what-is-the-behavior-of-uncaught-errors-in-react-16",
    num: 175,
    category: "misc",
  ...
  {
    slug: "misc-what-is-the-proper-placement-for-error-boundaries",
    num: 176,
    category: "misc",
    title: "What is the proper placement for error boundaries?",
    answer: `The granularity of error boundaries usage is up to the developer based on project needs. You can follow either of these approaches,
 1. You can wrap top-level route components to display a generic error message for the entire application.
 2. You can also wrap individual components in an error boundary to protect them from crashing the rest of the application.`,
  },
  {
    slug: "misc-what-is-the-benefit-of-component-stack-trace-from-error-boundary",
    num: 177,
    category: "misc",
    title: "What is the benefit of component stack trace from error boundary?",
    answer: `Apart from error messages and javascript stack, React16 will display the component stack trace with file names and line numbers using error boundary concept.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-the-purpose-of-displayname-class-property",
    num: 179,
    category: "misc",
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-the-browser-support-for-react-applications",
    num: 180,
    category: "misc",
  ...
  {
    slug: "misc-what-is-code-splitting",
    num: 181,
    category: "misc",
...
import React, { Component } from "react";
 ...
 export default App;
  ...
  {
    slug: "misc-what-are-keyed-fragments",
    num: 182,
    category: "misc",
    title: "What are Keyed Fragments?",
    answer: `The Fragments declared with the explicit <React.Fragment> syntax may have keys. The general use case is mapping a collection to an array of fragments as below,
 ...
 **Note:** key is the only attribute that can be passed to Fragment. In the future, there might be a support for additional attributes, such as event handlers.`,
  ...
  {
    slug: "misc-does-react-support-all-html-attributes",
    num: 183,
    category: "misc",
 ...
 These props work similarly to the corresponding HTML attributes, with the exception of the special cases. It also support all SVG attributes.`,
  ...
  {
    slug: "misc-when-component-props-defaults-to-true",
    num: 184,
    category: "misc",
    title: "When component props defaults to true?",
    answer: `If you pass no value for a prop, it defaults to true. This behavior is available so that it matches the behavior of HTML.
 ...
 **Note:** It is not recommended to use this approach because it can be confused with the ES6 object shorthand (example, \`{name}\` which is short for \`{name: name}\`)`,
  ...
  {
    slug: "misc-what-is-nextjs-and-major-features-of-it",
    num: 185,
    category: "misc",
    title: "What is NextJS and major features of it?",
    answer: `Next.js is a popular and lightweight framework for static and server‑rendered applications built with React. It also provides styling and routing solutions. Below are the major features provided by NextJS,
 ...
 6. Customizable with your own Babel and Webpack configurations`,
  ...
  {
    slug: "misc-how-do-you-pass-an-event-handler-to-a-component",
    num: 186,
    category: "misc",
    title: "How do you pass an event handler to a component?",
    answer: `You can pass event handlers and other functions as props to child components. The functions can be passed to child component as below,
 ...
 \`\`\``,
  ...
  {
    slug: "misc-how-to-prevent-a-function-from-being-called-multiple-times",
    num: 187,
    category: "misc",
    title: "How to prevent a function from being called multiple times?",
    answer: `If you use an event handler such as **onClick or onScroll** and want to prevent the callback from being fired too quickly, then you can limit the rate at which callback is executed. This can be achieved in the below possible ways,
 ...
 3. **RequestAnimationFrame throttling:** Changes based on requestAnimationFrame. For example, it can be used using raf-schd lodash function`,
  ...
  {
    slug: "misc-how-jsx-prevents-injection-attacks",
    num: 188,
    category: "misc",
    title: "How JSX prevents Injection Attacks?",
    answer: `React DOM escapes any values embedded in JSX before rendering them. Thus it ensures that you can never inject anything that’s not explicitly written in your application. Everything is converted to a string before being rendered.
 ...
 This way you can prevent XSS(Cross-site-scripting) attacks in the application.`,
  ...
  {
    slug: "misc-how-do-you-update-rendered-elements",
    num: 189,
    category: "misc",
    title: "How do you update rendered elements?",
    answer: `You can update UI(represented by rendered element) by passing the newly created element to ReactDOM's render method.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-how-do-you-say-that-props-are-readonly",
    num: 190,
    category: "misc",
    title: "How do you say that props are readonly?",
    answer: `When you declare a component as a function or a class, it must never modify its own props.
 ...
 The above function is called “pure” because it does not attempt to change their inputs, and always return the same result for the same inputs. Hence, React has a single rule saying "All React components must act like pure functions with respect to their props."`,
  ...
  {
    slug: "misc-what-are-the-conditions-to-safely-use-the-index-as-a-key",
    num: 191,
    category: "misc",
    title: "What are the conditions to safely use the index as a key?",
    answer: `There are three conditions to make sure, it is safe use the index as a key.
 ...
 3. The list is never reordered or filtered.`,
  ...
  {
    slug: "misc-should-keys-be-globally-unique",
    num: 192,
    category: "misc",
    title: "Should keys be globally unique?",
    answer: `The keys used within arrays should be unique among their siblings but they don’t need to be globally unique. i.e, You can use the same keys with two different arrays.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-the-popular-choice-for-form-handling",
    num: 193,
    category: "misc",
    title: "What is the popular choice for form handling?",
    answer: `\`Formik\` is a form library for react which provides solutions such as validation, keeping track of the visited fields, and handling form submission.
 ...
 It is used to create a scalable, performant, form helper with a minimal API to solve annoying stuff.`,
  ...
  {
    slug: "misc-what-are-the-advantages-of-formik-over-redux-form-library",
    num: 194,
    category: "misc",
    title: "What are the advantages of formik over redux form library?",
    answer: `Below are the main reasons to recommend formik over redux form library,
 ...
 3. Redux-Form is 22.5 kB minified gzipped whereas Formik is 12.7 kB`,
  ...
  {
    slug: "misc-why-are-you-not-required-to-use-inheritance",
    num: 195,
    category: "misc",
    title: "Why are you not required to use inheritance?",
 ...
 Whereas, If you want to reuse non-UI functionality between components, it is suggested to extract it into a separate JavaScript module. Later components import it and use that function, object, or class, without extending it.`,
  ...
  {
    slug: "misc-can-i-use-web-components-in-react-application",
    num: 196,
    category: "misc",
    title: "Can I use web components in react application?",
    answer: `Yes, you can use web components in a react application. Even though many developers won't use this combination, it may require especially if you are using third-party UI components that are written using Web Components.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-dynamic-import",
    num: 197,
    category: "misc",
    title: "What is dynamic import?",
    answer: `You can achieve code-splitting in your app using dynamic import.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-are-loadable-components",
    num: 198,
    category: "misc",
 ...
 Loadable Components provides additional benefits beyond just code-splitting, such as automatic code reloading, error handling, and preloading. By using Loadable Components, you can ensure that your application loads quickly and efficiently, providing a better user experience for your users.`,
  ...
  {
    slug: "misc-what-is-suspense-component",
    num: 199,
    category: "misc",
    title: "What is suspense component?",
    answer: `React Suspense is a built-in feature that lets you defer rendering part of your component tree until some condition(asynchronous operation) is met—usually, data or code has finished loading. While waiting, Suspense lets you display a fallback UI like a spinner or placeholder.
...
\`\`\``,
  ...
  {
    slug: "misc-what-is-route-based-code-splitting",
    num: 200,
    category: "misc",
    title: "What is route based code splitting?",
    answer: `One of the best place to do code splitting is with routes. The entire page is going to re-render at once so users are unlikely to interact with other elements in the page at the same time. Due to this, the user experience won't be disturbed.
 ...
 In the above code, the code splitting will happen at each route level.`,
  ...
  {
    slug: "misc-what-is-the-purpose-of-default-value-in-context",
    num: 201,
    category: "misc",
    title: "What is the purpose of default value in context?",
    answer: `The defaultValue argument is only used when a component does not have a matching Provider above it in the tree. This can be helpful for testing components in isolation without wrapping them.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-diffing-algorithm",
    num: 202,
    category: "misc",
 ...
 2. The developer can hint at which child elements may be stable across different renders with a key prop.`,
  ...
  {
    slug: "misc-what-are-the-rules-covered-by-diffing-algorithm",
    num: 203,
    category: "misc",
    title: "What are the rules covered by diffing algorithm?",
    answer: `When diffing two trees, React first compares the two root elements. The behavior is different depending on the types of the root elements. It covers the below rules during reconciliation algorithm,
 ...
 \`\`\``,
  ...
  {
    slug: "misc-when-do-you-need-to-use-refs",
    num: 204,
    category: "misc",
    title: "When do you need to use refs?",
    answer: `There are few use cases to go for refs,
 ...
 3. Integrating with third-party DOM libraries.`,
  ...
  {
    slug: "misc-must-prop-be-named-as-render-for-render-props",
    num: 205,
    category: "misc",
    title: "Must prop be named as render for render props?",
    answer: `Even though the pattern named render props, you don’t have to use a prop named render to use this pattern. i.e, Any prop that is a function that a component uses to know what to render is technically a “render prop”. Lets take an example with the children prop for render props,
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-are-the-problems-of-using-render-props-with-pure-components",
    num: 206,
    category: "misc",
  ...
  {
    slug: "misc-what-is-windowing-technique",
    num: 207,
    category: "misc",
  ...
  {
    slug: "misc-how-do-you-print-falsy-values-in-jsx",
    num: 208,
    category: "misc",
    title: "How do you print falsy values in JSX?",
    answer: `The falsy values such as false, null, undefined, and true are valid children but they don't render anything. If you still want to display them then you need to convert it to string. Let's take an example on how to convert to a string,
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-the-typical-use-case-of-portals",
    num: 209,
    category: "misc",
    title: "What is the typical use case of portals?",
    answer: `React Portals are primarily used to render UI components such as **modals, tooltips, dropdowns, hovercards, and notifications** outside of their parent component's DOM tree. This helps avoid common CSS issues caused by parent elements, such as:
 ...
 *   **stacking context and** \`**z-index**\` **conflicts** created by parent containers that prevent child elements from appearing above other content.
 ...
 That means, you need to visually “break out” of its container. By rendering these UI elements into a separate DOM node (often directly under \`<body>\`), portals ensure they appear above all other content and are not restricted by the parent’s CSS or layout constraints, resulting in correct positioning and visibility regardless of the parent’s styling.`,
  ...
  {
    slug: "misc-how-do-you-set-default-value-for-uncontrolled-component",
    num: 210,
    category: "misc",
    title: "How do you set default value for uncontrolled component?",
    answer: `In React, the value attribute on form elements will override the value in the DOM. With an uncontrolled component, you might want React to specify the initial value, but leave subsequent updates uncontrolled. To handle this case, you can specify a **defaultValue** attribute instead of **value**.
 ...
 The same applies for \`select\` and \`textArea\` inputs. But you need to use **defaultChecked** for \`checkbox\` and \`radio\` inputs.`,
  ...
  {
    slug: "misc-what-is-your-favorite-react-stack",
    num: 211,
    category: "misc",
 ...
 You can clone the project https://github.com/react-boilerplate/react-boilerplate and start working on any new react project.`,
  ...
  {
    slug: "misc-what-is-the-difference-between-real-dom-and-virtual-dom",
    num: 212,
    category: "misc",
    title: "What is the difference between Real DOM and Virtual DOM?",
    answer: `Below are the main differences between Real DOM and Virtual DOM,
 ...
 | Creates a new DOM if element updates | It updates the JSX if element update |`,
  ...
  {
    slug: "misc-how-to-add-bootstrap-to-a-react-application",
    num: 213,
    category: "misc",
    title: "How to add Bootstrap to a react application?",
    answer: `Bootstrap can be added to your React app in a three possible ways,
 ...
 3. React Bootstrap Package:
  ...
  {
    slug: "misc-can-you-list-down-top-websites-or-applications-using-react-as-front-end-framework",
    num: 214,
    category: "misc",
    title: "Can you list down top websites or applications using react as front end framework?",
    answer: `Below are the \`top 10 websites\` using React as their front-end framework,
 ...
 10. PayPal`,
  ...
  {
    slug: "misc-is-it-recommended-to-use-css-in-js-technique-in-react",
    num: 215,
    category: "misc",
  ...
  {
    slug: "misc-do-i-need-to-rewrite-all-my-class-components-with-hooks",
    num: 216,
    category: "misc",
    title: "Do I need to rewrite all my class components with hooks?",
    answer: `No. But you can try Hooks in a few components(or new components) without rewriting any existing code. Because there are no plans to remove classes in ReactJS.`,
  },
  {
    slug: "misc-what-is-useeffect-hook-how-to-fetch-data-with-react-hooks",
    num: 217,
    category: "misc",
    title: "What is useEffect hook? How to fetch data with React Hooks?",
    answer: `The \`useEffect\` hook is a React Hook that lets you perform **side effects** in function components. Side effects are operations that interact with the outside world or system and aren't directly related to rendering UI — such as fetching data, setting up subscriptions, timers, manually manipulating the DOM, etc.
 ...
 **Syntax**
 ...
 We provided an empty array as second argument to the useEffect hook to avoid activating it on component updates. This way, it only fetches on component mount.`,
  ...
  {
    slug: "misc-is-hooks-cover-all-use-cases-for-classes",
    num: 218,
    category: "misc",
    title: "Is Hooks cover all use cases for classes?",
    answer: `Hooks doesn't cover all use cases of classes but there is a plan to add them soon. Currently there are no Hook equivalents to the uncommon **getSnapshotBeforeUpdate** and **componentDidCatch** lifecycles yet.`,
  },
  {
    slug: "misc-what-is-the-stable-release-for-hooks-support",
    num: 219,
    category: "misc",
    title: "What is the stable release for hooks support?",
    answer: `React includes a stable implementation of React Hooks in 16.8 release for below packages
 ...
 4. React Shallow Renderer`,
  ...
  {
    slug: "misc-why-do-we-use-array-destructuring-square-brackets-notation-in-usestate",
    num: 220,
    category: "misc",
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-are-the-sources-used-for-introducing-hooks",
    num: 221,
    category: "misc",
    title: "What are the sources used for introducing hooks?",
    answer: `Hooks got the ideas from several different sources. Below are some of them,
 ...
 5. Reducer components in ReasonReact.`,
  ...
  {
    slug: "misc-how-do-you-access-imperative-api-of-web-components",
    num: 222,
    category: "misc",
  ...
  {
    slug: "misc-what-is-formik",
    num: 223,
    category: "misc",
    title: "What is formik?",
    answer: `Formik is a small react form library that helps you with the three major problems,
 ...
 3. Handling form submission`,
  ...
  {
    slug: "misc-what-are-typical-middleware-choices-for-handling-asynchronous-calls-in-redux",
    num: 224,
    category: "misc",
    title: "What are typical middleware choices for handling asynchronous calls in Redux?",
    answer: `Some of the popular middleware choices for handling asynchronous calls in Redux eco system are \`Redux Thunk, Redux Promise, Redux Saga\`.`,
  },
  {
    slug: "misc-do-browsers-understand-jsx-code",
    num: 225,
    category: "misc",
    title: "Do browsers understand JSX code?",
    answer: `No, browsers can't understand JSX code. You need a transpiler to convert your JSX to regular Javascript that browsers can understand. The most widely used transpiler right now is Babel.`,
  },
  {
    slug: "misc-describe-about-data-flow-in-react",
    num: 226,
    category: "misc",
    title: "Describe about data flow in react?",
    answer: `React implements one-way reactive data flow using props which reduce boilerplate and is easier to understand than traditional two-way data binding.`,
  },
  {
    slug: "misc-what-is-mobx",
    num: 227,
    category: "misc",
    title: "What is MobX?",
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-are-the-differences-between-redux-and-mobx",
    num: 228,
    category: "misc",
    title: "What are the differences between Redux and MobX?",
    answer: `Below are the main differences between Redux and MobX,
 ...
 | How it stores | Uses JS Object to store                                       | Uses observable to store the data                                      |`,
  ...
  {
    slug: "misc-should-i-learn-es6-before-learning-reactjs",
    num: 229,
    category: "misc",
    title: "Should I learn ES6 before learning ReactJS?",
    answer: `No, you don’t have to learn es2015/es6 to learn react. But you may find many resources or React ecosystem uses ES6 extensively. Let's see some of the frequently used ES6 features,
 ...
 3. **Arrow functions:** Makes compact syntax
  ...
  {
    slug: "misc-what-is-concurrent-rendering",
    num: 230,
    category: "misc",
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-the-difference-between-async-mode-and-concurrent-mode",
    num: 231,
    category: "misc",
    title: "What is the difference between async mode and concurrent mode?",
    answer: `Both refers the same thing. Previously concurrent Mode being referred to as "Async Mode" by React team. The name has been changed to highlight React’s ability to perform work on different priority levels. So it avoids the confusion from other approaches to Async Rendering.`,
  },
  {
    slug: "misc-can-i-use-javascript-urls-in-react16-9",
    num: 232,
    category: "misc",
    title: "Can I use javascript urls in react16.9?",
    answer: `Yes, you can use javascript: URLs but it will log a warning in the console. Because URLs starting with javascript: are dangerous by including unsanitized output in a tag like \`<a href>\` and create a security hole.
 ...
 Remember that the future versions will throw an error for javascript URLs.`,
  ...
  {
    slug: "misc-what-is-the-purpose-of-eslint-plugin-for-hooks",
    num: 233,
    category: "misc",
    title: "What is the purpose of eslint plugin for hooks?",
    answer: `The ESLint plugin enforces rules of Hooks to avoid bugs. It assumes that any function starting with ”use” and a capital letter right after it is a Hook. In particular, the rule enforces that,

 1. Calls to Hooks are either inside a PascalCase function (assumed to be a component) or another useSomething function (assumed to be a custom Hook).
 2. Hooks are called in the same order on every render.`,
  },
  {
    slug: "misc-what-is-the-difference-between-imperative-and-declarative-in-react",
    num: 234,
    category: "misc",
    title: "What is the difference between Imperative and Declarative in React?",
    answer: `Imagine a simple UI component, such as a "Like" button. When you tap it, it turns blue if it was previously grey, and grey if it was previously blue.
 ...
 Because the declarative approach separates concerns, this part of it only needs to handle how the UI should look in a specific state, and is therefore much simpler to understand.`,
  ...
  {
    slug: "misc-what-are-the-benefits-of-using-typescript-with-reactjs",
    num: 235,
    category: "misc",
    title: "What are the benefits of using TypeScript with ReactJS?",
    answer: `Below are some of the benefits of using TypeScript with ReactJS,
 ...
 4. Avoid bugs with the ease of readability and Validation`,
  ...
  {
    slug: "misc-how-do-you-make-sure-that-user-remains-authenticated-on-page-refresh-while-using-context-a",
    num: 236,
    category: "misc",
    title: "How do you make sure that user remains authenticated on page refresh while using Context API State Management?",
    answer: `When a user logs in and reload, to persist the state generally we add the load user action in the useEffect hooks in the main App.js. While using Redux, loadUser action can be easily accessed.
 ...
 **loadUser**
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-are-the-benefits-of-new-jsx-transform",
    num: 237,
    category: "misc",
    title: "What are the benefits of new JSX transform?",
    answer: `There are three major benefits of new JSX transform,
 ...
 3. The future improvements provides the flexibility to reduce the number of concepts to learn React.`,
  ...
  {
    slug: "misc-how-is-the-new-jsx-transform-different-from-old-transform",
    num: 238,
    category: "misc",
    title: "How is the new JSX transform different from old transform??",
    answer: `The new JSX transform doesn’t require React to be in scope. i.e, You don't need to import React package for simple scenarios.
 ...
 **Note:** You still need to import React to use Hooks.`,
  ...
  {
    slug: "misc-what-are-react-server-components",
    num: 239,
    category: "misc",
    title: "What are React Server components?",
    answer: `React Server Component is a way to write React component that gets rendered in the server-side with the purpose of improving React app performance. These components allow us to load components from the backend.

 **Note:** React Server Components is still under development and not recommended for production yet.`,
  },
  {
    slug: "misc-what-is-prop-drilling",
    num: 240,
    category: "misc",
    title: "What is prop drilling?",
    answer: `Prop Drilling is the process by which you pass data from one component of the React Component tree to another by going through other components that do not need the data but only help in passing it around.`,
  },
  {
    slug: "misc-what-is-the-difference-between-usestate-and-useref-hook",
    num: 241,
    category: "misc",
    title: "What is the difference between useState and useRef hook?",
    answer: `1. useState causes components to re-render after state updates whereas useRef doesn’t cause a component to re-render when the value or state changes.
 ...
 2. useState allows us to update the state inside components. While useRef allows referencing DOM elements and tracking values.`,
  ...
  {
    slug: "misc-what-is-a-wrapper-component",
    num: 242,
    category: "misc",
    title: "What is a wrapper component?",
    answer: `A wrapper in React is a component that wraps or surrounds another component or group of components. It can be used for a variety of purposes such as adding additional functionality, styling, or layout to the wrapped components.
 ...
 This way, the wrapper component can add additional functionality, styling, or layout to the wrapped component while keeping the wrapped component simple and reusable.`,
  ...
  {
    slug: "misc-what-are-the-differences-between-useeffect-and-uselayouteffect-hooks",
    num: 243,
    category: "misc",
    title: "What are the differences between useEffect and useLayoutEffect hooks?",
    answer: `useEffect and useLayoutEffect are both React hooks that can be used to synchronize a component with an external system, such as a browser API or a third-party library. However, there are some key differences between the two:
 ...
 In general, it's recommended to use useEffect as much as possible, because it is more performant and less prone to errors. useLayoutEffect should only be used when you need to measure or update layout, and you can't achieve the same result using useEffect.`,
  ...
  {
    slug: "misc-what-are-the-differences-between-functional-and-class-components",
    num: 244,
    category: "misc",
 ...
 **A simple example showing how we use the setState() and constructor():**
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-is-strict-mode-in-react",
    num: 245,
    category: "misc",
    title: "What is strict mode in React?",
    answer: `\`React.StrictMode\` is a useful component for highlighting potential problems in an application. Just like \`<Fragment>\`, \`<StrictMode>\` does not render any extra DOM elements. It activates additional checks and warnings for its descendants. These checks apply for _development mode_ only.
 ...
 **Note:** Frameworks such as NextJS has this flag enabled by default.`,
  ...
  {
    slug: "misc-what-is-the-benefit-of-strict-mode",
    num: 246,
    category: "misc",
    title: "What is the benefit of strict mode?",
    answer: `The <StrictMode> will be helpful in the below cases,
 ...
 7. Warning about deprecated **findDOMNode** usage`,
  ...
  {
    slug: "misc-why-does-strict-mode-render-twice-in-react",
    num: 247,
    category: "misc",
    title: "Why does strict mode render twice in React?",
    answer: `StrictMode renders components twice in development mode(not production) in order to detect any problems with your code and warn you about those problems. This is used to detect accidental side effects in the render phase. If you used \`create-react-app\` development tool then it automatically enables StrictMode by default.
 ...
 5. State updater functions`,
  ...
  {
    slug: "misc-what-are-the-rules-of-jsx",
    num: 248,
    category: "misc",
    title: "What are the rules of JSX?",
    answer: `The below 3 rules needs to be followed while using JSX in a react application.
 ...
 3. **Use camelCase naming:**
  ...
  {
    slug: "misc-what-is-the-reason-behind-multiple-jsx-tags-to-be-wrapped",
    num: 249,
    category: "misc",
  ...
  {
    slug: "misc-how-do-you-prevent-mutating-array-variables",
    num: 250,
    category: "misc",
    title: "How do you prevent mutating array variables?",
    answer: `The preexisting variables outside of the function scope including state, props and context leads to a mutation and they result in unpredictable bugs during the rendering stage. The below points should be taken care while working with arrays variables.
  ...
  {
    slug: "misc-what-are-capture-phase-events",
    num: 251,
    category: "misc",
    title: "What are capture phase events?",
    answer: `The \`onClickCapture\` React event is helpful to catch all the events of child elements irrespective of event propagation logic or even if the events propagation stopped. This is useful if you need to log every click events for analytics purpose.
 ...
 3. It travels upwards in the DOM tree by call all \`onClick\` event handlers above to it.`,
  ...
  {
    slug: "misc-how-does-react-updates-screen-in-an-application",
    num: 252,
    category: "misc",
    title: "How does React updates screen in an application?",
    answer: `React updates UI in three steps,
 ...
 3. **Commit changes to DOM:** After calling components, React will modify the DOM for initial render using \`appendChild()\` DOM API and apply minimal necessary DOM updates for re-renders based on differences between rerenders.`,
  ...
  {
    slug: "misc-how-does-react-batch-multiple-state-updates",
    num: 253,
    category: "misc",
  ...
  {
    slug: "misc-is-it-possible-to-prevent-automatic-batching",
    num: 254,
    category: "misc",
  ...
  {
    slug: "misc-what-is-react-hydration",
    num: 255,
    category: "misc",
  ...
  {
    slug: "misc-how-do-you-update-objects-inside-state",
    num: 256,
    category: "misc",
  ...
  {
    slug: "misc-how-do-you-update-nested-objects-inside-state",
    num: 257,
    category: "misc",
  ...
  {
    slug: "misc-how-do-you-update-arrays-inside-state",
    num: 258,
    category: "misc",
  ...
  {
    slug: "misc-how-do-you-use-immer-library-for-state-updates",
    num: 259,
    category: "misc",
    title: "How do you use immer library for state updates?",
    answer: `Immer library enforces the immutability of state based on **copy-on-write** mechanism. It uses JavaScript proxy to keep track of updates to immutable states. Immer has 3 main states as below,
  ...
  {
    slug: "misc-what-are-the-benefits-of-preventing-the-direct-state-mutations",
    num: 260,
    category: "misc",
  ...
  {
    slug: "misc-what-are-the-preferred-and-non-preferred-array-operations-for-updating-the-state",
    num: 261,
    category: "misc",
    title: "What are the preferred and non-preferred array operations for updating the state?",
    answer: `The below table represent preferred and non-preferred array operations for updating the component state.
  ...
  {
    slug: "misc-what-will-happen-by-defining-nested-function-components",
    num: 262,
    category: "misc",
    title: "What will happen by defining nested function components?",
    answer: `Technically it is possible to write nested function components but it is not suggested to write nested function definitions. Because it leads to unexpected bugs and performance issues.`,
  },
  {
    slug: "misc-can-i-use-keys-for-non-list-items",
    num: 263,
    category: "misc",
    title: "Can I use keys for non-list items?",
    answer: `Keys are primarily used for rendering list items but they are not just for list items. You can also use them React to distinguish components. By default, React uses order of the components in`,
  },
  {
    slug: "misc-what-are-the-guidelines-to-be-followed-for-writing-reducers",
    num: 264,
    category: "misc",
    title: "What are the guidelines to be followed for writing reducers?",
    answer: `There are two guidelines to be taken care while writing reducers in your code.
 ...
 2. Each action should describe a single user interaction even though there are multiple changes applied to data. For example, if you "reset" registration form which has many user input fields managed by a reducer, it is suggested to send one "reset" action instead of creating separate action for each fields. The proper ordering of actions should reflect the user interactions in the browser and it helps a lot for debugging purpose.`,
  ...
  {
    slug: "misc-how-does-reactjs-work-behind-the-scenes",
    num: 265,
    category: "misc",
    title: "How does ReactJS work behind the scenes?",
    answer: `ReactJS is a powerful JavaScript library for building user interfaces. While it appears simple on the surface, React performs a lot of complex operations behind the scenes to efficiently update the UI. Here's an overview of how it works internally:
 ...
 React uses an internal **Scheduler** to control how updates are prioritized:
  ...
  {
    slug: "misc-how-is-usereducer-different-from-usestate",
    num: 266,
    category: "misc",
    title: "How is `useReducer` Different from `useState`?",
    answer: `There are notable differences between \`useState\` and \`useReducer\` hooks.
  ...
  {
    slug: "misc-what-is-usecontext-what-are-the-steps-to-follow-for-usecontext",
    num: 267,
    category: "misc",
    title: "What is useContext? What are the steps to follow for useContext?",
    answer: `The \`useContext\` hook is a built-in React Hook that lets you access the value of a context inside a functional component without needing to wrap it in a <Context.Consumer> component.
 ...
 The usage of useContext involves three main steps:
  ...
  {
    slug: "misc-what-are-the-use-cases-of-usecontext-hook",
    num: 268,
    category: "misc",
    title: "What are the use cases of useContext hook?",
    answer: `The \`useContext\` hook in React is used to share data across components without having to pass props manually through each level. Here are some common and effective use cases:
  ...
  {
    slug: "misc-when-to-use-client-and-server-components",
    num: 269,
    category: "misc",
    title: "When to use client and server components?",
    answer: `You can efficiently build nextjs application if you are aware about which part of the application needs to use client components and which other parts needs to use server components. The common cases of both client and server components are listed below:
  ...
  {
    slug: "misc-what-are-the-differences-between-page-router-and-app-router-in-nextjs",
    num: 270,
    category: "misc",
    title: "What are the differences between page router and app router in nextjs?",
    answer: `Next.js provides two different routing systems: the **Page Router** (traditional) and the **App Router** (introduced in Next.js 13). The App Router is built on React Server Components and offers more powerful features for modern web applications.
 ...
 **Note:** The App Router is recommended for new Next.js applications as it provides better performance, simpler data fetching patterns, and improved developer experience with React Server Components.`,
  ...
  {
    slug: "misc-can-you-describe-the-usememo-hook",
    num: 271,
    category: "misc",
    title: "Can you describe the useMemo() Hook?",
    answer: `The \`useMemo()\` Hook in React is used to **optimize performance** by **memoizing the result of expensive calculations**. It ensures that a function is **only re-executed when its dependencies change**, preventing unnecessary computations on every re-render.
 ...
 - **\`dependencies\`**:  
  ...
  {
    slug: "misc-can-hooks-be-used-in-class-components",
    num: 272,
    category: "misc",
    title: "Can Hooks be used in class components?",
    answer: `No, Hooks cannot be used inside class components. They are specially designed for function components. This is because hooks depend on the sequence in which they are called during a component’s render, something that's only guaranteed in functional components. However, both class and function components can coexist in the same application.`,
  },
  {
    slug: "misc-what-is-an-updater-function-should-an-updater-function-be-used-in-all-cases",
    num: 273,
    category: "misc",
    title: "What is an updater function? Should an updater function be used in all cases?",
    answer: `An **updater function** is a form of \`setState\` where you pass a **function** instead of a direct value. This function receives the **previous state** as an argument and returns the **next state**.
 ...
 **Example: Multiple Updates in One Handler**
 ...
 \`\`\``,
  ...
  {
    slug: "misc-can-usestate-take-a-function-as-an-initial-value",
    num: 274,
    category: "misc",
    title: "Can useState take a function as an initial value?",
    answer: `Yes, \`useState\` can take a function as an initial value, and this is a useful feature in React called **lazy initialization**. This function is also known as **initializer function**.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-types-of-values-can-usestate-hold",
    num: 275,
    category: "misc",
    title: "What types of values can `useState` hold?",
    answer: `The \`useState\` hook accepts different types of values.
 ...
 *   \`null\` or \`undefined\`
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-happens-if-you-call-usestate-conditionally",
    num: 276,
    category: "misc",
    title: "What happens if you call `useState` conditionally?",
    answer: `As per rules of React Hooks, hooks must be called unconditionally. For example, if you conditionally call it:
 \`\`\`js
 if (someCondition) { 
 ...
 React will throw a runtime error because it **relies on the order of Hook calls**, and conditional logic breaks that order.`,
  ...
  {
    slug: "misc-is-usestate-synchronous-or-asynchronous",
    num: 277,
    category: "misc",
    title: "Is useState Synchronous or Asynchronous?",
    answer: `The \`useState\` hook is synchronous, but state updates are asynchronous. When you call \`useState()\`, it runs synchronously and returns the state variable and setter function as tuple.
 \`\`\`js
 const [count, setCount] = useState(0);
 \`\`\`
 ...
 **Example:**
 ...
 To see the updated state value, you can use \`useEffect()\` hook. It runs **after the component has re-rendered.**  By the time \`useEffect\` runs:
  ...
  {
    slug: "misc-can-you-explain-how-usestate-works-internally",
    num: 278,
    category: "misc",
    title: "Can you explain how useState works internally?",
    answer: `React’s hooks, including \`useState\`, rely on some internal machinery that keeps track of state **per component** and **per hook call** during rendering. Here's a simplified explanation of the internal mechanics:
  ...
  *   That’s why you can’t call hooks conditionally.
  ...
  {
    slug: "misc-what-is-usereducer-why-do-you-use-usereducer",
    num: 279,
    category: "misc",
    title: "What is `useReducer`? Why do you use useReducer?",
    answer: `The \`useReducer\` hook is a React hook used to manage **complex state logic** inside **functional components**. It is conceptually similar to **Redux**. i.e, Instead of directly updating state like with \`useState\`, you **dispatch an action** to a **reducer function**, and the reducer returns the new state.
 ...
 *   You’re managing features like:
  ...
  {
    slug: "misc-how-does-usereducer-works-explain-with-an-example",
    num: 280,
    category: "misc",
    title: "How does `useReducer` works? Explain with an example",
    answer: `The \`useReducer\` hooks works similarly to Redux, where:
 ...
 **Counter Example with Increment, Decrement, and Reset:**
 ...
 2. Using \`useReducer\`:
  ...
  {
    slug: "misc-can-you-combine-usereducer-with-usecontext",
    num: 281,
    category: "misc",
    title: "Can you combine useReducer with useContext?",
    answer: `Yes, it's common to combine **useReducer** with **useContext** to build a lightweight state management system similar to Redux:
  ...
  {
    slug: "misc-can-you-dispatch-multiple-actions-in-a-row-with-usereducer",
    num: 282,
    category: "misc",
    title: "Can you dispatch multiple actions in a row with useReducer?",
    answer: `Yes, you can dispatch multiple actions in a row using \`useReducer\` but not directly in one call. You'd have to call dispatch multiple times or create a composite action in your reducer that performs multiple updates based on the action type.
 ...
 **Note:** You can also define a custom action type If you want multiple state changes to be handled in one reducer call.
 ...
 \`\`\``,
  ...
  {
    slug: "misc-is-dispatch-from-usereducer-asynchronous-and-does-it-update-state-immediately",
    num: 283,
    category: "misc",
    title: "Is dispatch from useReducer asynchronous and does it update state immediately?",
    answer: `The \`dispatch\` function returned by \`useReducer\` is **not asynchronous** — it is a **synchronous** function call. When you call \`dispatch(action)\`, React **synchronously** invokes your reducer with the current state and the action, computes the new state, and **schedules a re-render**. However, the **state variable does not update immediately** within the same render cycle. The updated state is only available in the **next render**.
 ...
 **Note:** This behavior is by design in React. The \`dispatch\` function itself has a **stable identity** (it doesn't change between re-renders), which makes it safe to omit from \`useEffect\` dependency arrays.`,
  ...
  {
    slug: "misc-how-does-usecontext-works-explain-with-an-example",
    num: 284,
    category: "misc",
    title: "How does useContext works? Explain with an example",
    answer: `The \`useContext\` hook can be used for authentication state management across multiple components and pages in a React application.
 ...
 **4. Dashboard with logout:**
  ...
  {
    slug: "misc-can-you-use-multiple-contexts-in-one-component",
    num: 285,
    category: "misc",
    title: "Can You Use Multiple Contexts in One Component?",
    answer: `Yes, it is possible. You can use multiple contexts inside the same component by calling useContext multiple times, once for each context.
 ...
 **Example: Using \`ThemeContext\` and \`UserContext\` Together**
 ...
 \`\`\``,
  ...
  {
    slug: "misc-what-s-a-common-pitfall-when-using-usecontext-with-objects",
    num: 286,
    category: "misc",
    title: "What's a common pitfall when using useContext with objects?",
    answer: `A **common pitfall** when using \`useContext\` with objects is **triggering unnecessary re-renders** across all consuming components — even when only part of the context value changes.
 ...
 **2. Memoize Context Value**  
 ...
 However, this only helps if the object structure and dependencies are well controlled.`,
  ...
  {
    slug: "misc-what-would-the-context-value-be-for-no-matching-provider",
    num: 287,
    category: "misc",
    title: "What would the context value be for no matching provider?",
    answer: `When a component calls \`useContext(SomeContext)\` but **no matching** \`<SomeContext.Provider>\` **is present higher up in the component tree**, the **default value** passed to \`React.createContext(defaultValue)\` is returned.
 ...
 **Note:** If you don’t specify a default value, the context value will be undefined when used without a provider:
 ...
 \`\`\``,
  ...
  {
    slug: "misc-how-do-reactive-dependencies-in-the-useeffect-dependency-array-affect-its-execution-behavi",
    num: 288,
    category: "misc",
    title: "How do reactive dependencies in the useEffect dependency array affect its execution behavior?",
    answer: `The \`useEffect\` hook accepts an optional dependencies argument that accepts an array of reactive values. The **dependency array** determines **when** the effect runs. i.e, It makes \`useEffect\` _reactive_ to changes in specified values.
 ...
 3. **No Dependency Array (Omitted)**
  ...
  {
    slug: "misc-when-and-how-often-does-react-invoke-the-setup-and-cleanup-functions-inside-a-useeffect-ho",
    num: 289,
    category: "misc",
    title: "When and how often does React invoke the setup and cleanup functions inside a useEffect hook?",
    answer: `1. **Setup Function Execution (\`useEffect\`)**
 ...
 2. **Cleanup Function Execution (Returned function from \`useEffect\`)**
  ...
  {
    slug: "misc-what-happens-if-you-return-a-promise-from-useeffect",
    num: 290,
    category: "misc",
    title: "What happens if you return a Promise from useEffect??",
    answer: `You should NOT return a Promise from useEffect. React expects the function passed to useEffect to return either nothing (undefined) or a cleanup function (synchronous function). i.e, It does not expect or handle a returned Promise. If you still return a Promise, React will ignore it silently, and it may lead to bugs or warnings in strict mode.
  ...
  **Correct:**
  ...
  {
    slug: "misc-can-you-have-multiple-useeffect-hooks-in-a-single-component",
    num: 290,
    category: "misc",
    title: "Can you have multiple useEffect hooks in a single component?",
    answer: `Yes, multiple useEffect hooks are allowed and recommended when you want to separate concerns.
  ...
  {
    slug: "misc-how-to-prevent-infinite-loops-with-useeffect",
    num: 291,
    category: "misc",
    title: "How to prevent infinite loops with useEffect?",
    answer: `Infinite loops happen when the effect updates state that’s listed in its own dependency array, which causes the effect to re-run, updating state again and so on.
  ...
  {
    slug: "misc-what-are-the-usecases-of-uselayouteffect",
    num: 292,
    category: "misc",
    title: "What are the usecases of useLayoutEffect?",
    answer: `You need to use \`useLayoutEffect\` when your effect **must run before the browser paints**, such as:
  ...
  *   **Integrating with third-party libraries** that require DOM manipulation
  ...
  {
    slug: "misc-how-does-uselayouteffect-work-during-server-side-rendering-ssr",
    num: 293,
    category: "misc",
    title: "How does useLayoutEffect work during server-side rendering (SSR)?",
    answer: `The \`useLayoutEffect\` hook does **not run on the server**, because there is no DOM. React issues a warning in server environments like Next.js if \`useLayoutEffect\` is used directly.
 ...
 This can be mitigated using a conditional polyfill:
  ...
  {
    slug: "misc-what-happens-if-you-use-uselayouteffect-for-non-layout-logic",
    num: 294,
    category: "misc",
    title: "What happens if you use useLayoutEffect for non-layout logic?",
    answer: `Using \`useLayoutEffect\` for logic **unrelated to layout or visual DOM changes** (such as logging, data fetching, or analytics) is **not recommended**. It can lead to **performance issues** or even unexpected behavior.
  ...
  **Example:**
  ...
  {
    slug: "misc-how-do-you-use-useref-to-access-a-dom-element-in-react-give-an-example",
    num: 296,
    category: "misc",
    title: "How Do You Use useRef to Access a DOM Element in React? Give an example.",
    answer: `The \`useRef\` hook is commonly used in React to directly reference and interact with DOM elements — like focusing an input, scrolling to a section, or controlling media elements.
  ...
  {
    slug: "misc-can-you-use-useref-to-persist-values-across-renders",
    num: 297,
    category: "misc",
    title: "Can you use useRef to persist values across renders??",
    answer: `Yes, you can use \`useRef\` to persist values across renders in React. Unlike \`useState\`, changing \`.current\` does not cause re-renders, but the value is preserved across renders.
  ...
  {
    slug: "misc-can-useref-be-used-to-store-previous-values",
    num: 298,
    category: "misc",
    title: "Can useRef be used to store previous values?",
    answer: `Yes, \`useRef\` is a common pattern when you want to compare current and previous props or state without causing re-renders.
  ...
  {
    slug: "misc-is-it-possible-to-access-a-ref-in-the-render-method",
    num: 299,
    category: "misc",
    title: "Is it possible to access a ref in the render method?",
    answer: `Yes, you can access a ref in the render method, but what you get from it depends on how you're using the ref and when in the component lifecycle you're rendering.
  ...
  {
    slug: "misc-what-are-the-common-usecases-of-useref-hook",
    num: 300,
    category: "misc",
    title: "What are the common usecases of useRef hook?",
    answer: `Some of the common cases are:
  ...
  *   Integrate with non-React libraries (like D3 or jQuery).`,
  ...
  {
    slug: "misc-what-is-useimperativehandle-hook-give-an-example",
    num: 301,
    category: "misc",
    title: "What is useImperativeHandle Hook? Give an example.",
    answer: `\`useImperativeHandle\` is a React Hook that allows a **child component** to expose **custom functions or properties** to its **parent component**, when using \`ref\`.
  ...
  **Example: Dialog component**
  ...
  {
    slug: "misc-when-should-you-use-useimperativehandle",
    num: 302,
    category: "misc",
    title: "When should you use useImperativeHandle?",
    answer: `The useImperativeHandler hook will be used in below cases:
  ...
  *   You're building **reusable component libraries** (e.g., inputs, modals, form controls).`,
  ...
  {
    slug: "misc-is-that-possible-to-use-useimperativehandle-without-forwardref",
    num: 303,
    category: "misc",
    title: "Is that possible to use useImperativeHandle without forwardRef?",
    answer: `**No.** \`useImperativeHandle\` only works when the component is wrapped in \`forwardRef\`. It's the combination that allows parent components to use a \`ref\` on a function component.`,
  },
  {
    slug: "misc-how-is-usememo-different-from-usecallback",
    num: 304,
    category: "misc",
    title: "How is useMemo different from useCallback?",
    answer: `The following table compares both useMemo and useCallback:
  ...
  {
    slug: "misc-does-usememo-prevent-re-rendering-of-child-components",
    num: 305,
    category: "misc",
    title: "Does useMemo prevent re-rendering of child components?",
    answer: `The \`useMemo\` hook **does not directly prevent re-rendering of child components**. Its main purpose is to memoize the result of an expensive computation so that it doesn’t get recalculated unless its dependencies change. While this can improve performance, it doesn’t inherently control whether a child component re-renders.
  ...
  {
    slug: "misc-what-is-usecallback-and-why-is-it-used",
    num: 306,
    category: "misc",
    title: "What is `useCallback` and why is it used?",
    answer: `The \`useCallback\` is a React Hook used to memoize **function definitions** between renders. It returns the same function reference unless its dependencies change. This is especially useful when passing callbacks to optimized child components (e.g. those wrapped in \`React.memo\`) to prevent unnecessary re-renders.
  ...
  {
    slug: "misc-what-are-custom-react-hooks-and-how-can-you-develop-one",
    num: 307,
    category: "misc",
    title: "What are Custom React Hooks, and How Can You Develop One?",
    answer: `**Custom Hooks** in React are JavaScript functions that allow you to **extract and reuse component logic** using React’s built-in Hooks like \`useState\`, \`useEffect\`, etc.
  ...
  **Example: AuthorList component**
  ...
  {
    slug: "misc-how-does-react-fiber-works-explain-in-detail",
    num: 309,
    category: "misc",
    title: "How does React Fiber works? Explain in detail.",
    answer: `React Fiber is the **core engine** that enables advanced features like **concurrent rendering**, **prioritization**, and **interruptibility** in React. Here's how it works:
  ...
  *   Updates can be **assigned priorities**, so urgent updates (like clicks) are handled faster than background work.`,
  ...
  {
    slug: "misc-what-is-the-useid-hook-and-when-should-you-use-it",
    num: 310,
    category: "misc",
    title: "What is the useId hook and when should you use it?",
    answer: `The \`useId\` hook is a React hook introduced in React 18 that generates **unique IDs** that are stable across server and client renders. It's primarily used for **accessibility attributes** like linking form labels to inputs.
 ...
 **Note:** The IDs generated by \`useId\` contain colons (\`:\`) which may not work in CSS selectors. For multiple related IDs, you can use the same \`id\` as a prefix: \`\${id}-firstName\`, \`\${id}-lastName\`.`,
  ...
  {
    slug: "misc-what-is-the-usedeferredvalue-hook",
    num: 311,
    category: "misc",
    title: "What is the useDeferredValue hook?",
    answer: `The \`useDeferredValue\` hook is used to **defer updating a part of the UI** to keep other parts responsive. It accepts a value and returns a "deferred" version of that value that may lag behind. This is useful for optimizing performance when rendering expensive components.
 ...
 The input stays responsive while the expensive \`SearchResults\` component re-renders with a slight delay using the deferred value.`,
  ...
  {
    slug: "misc-what-is-the-usetransition-hook-and-how-does-it-differ-from-usedeferredvalue",
    num: 312,
    category: "misc",
    title: "What is the useTransition hook and how does it differ from useDeferredValue?",
    answer: `The \`useTransition\` hook allows you to mark certain state updates as **non-urgent transitions**, keeping the UI responsive during expensive re-renders. It returns a \`isPending\` flag and a \`startTransition\` function.
 ...
 | Pending state | Built-in \`isPending\` flag | Manual comparison needed |`,
  ...
  {
    slug: "misc-what-is-the-usesyncexternalstore-hook",
    num: 313,
    category: "misc",
    title: "What is the useSyncExternalStore hook?",
    answer: `The \`useSyncExternalStore\` hook is designed to **subscribe to external stores** (non-React state sources) in a way that's compatible with concurrent rendering. It's primarily used by library authors for state management libraries.
 ...
 This hook ensures that when the external store changes, React re-renders consistently without tearing (showing inconsistent data).`,
  ...
  {
    slug: "misc-what-is-the-useinsertioneffect-hook",
    num: 314,
    category: "misc",
    title: "What is the useInsertionEffect hook?",
    answer: `The \`useInsertionEffect\` hook is designed for **CSS-in-JS library authors** to inject styles into the DOM before any layout effects run. It fires synchronously before DOM mutations.
 ...
 **Note:** This hook is not intended for application code. It's specifically for CSS-in-JS libraries like styled-components or Emotion to prevent style flickering.`,
  ...
  {
    slug: "misc-how-do-you-share-state-logic-between-components-using-custom-hooks",
    num: 315,
    category: "misc",
    title: "How do you share state logic between components using custom hooks?",
    answer: `Custom hooks allow you to **extract and share stateful logic** between components without changing their hierarchy. The state itself is not shared—each component using the hook gets its own isolated state.
 ...
 Both components use \`useLocalStorage\`, but each has **its own independent state** that persists to localStorage.`,
  ...
  {
    slug: "misc-what-is-the-usedebugvalue-hook",
    num: 316,
    category: "misc",
    title: "What is the useDebugValue hook?",
    answer: `The \`useDebugValue\` hook is used to **display a label** for custom hooks in **React DevTools**. It helps developers debug custom hooks by showing meaningful information.
 ...
 **Note:** Only use \`useDebugValue\` in custom hooks that are part of shared libraries. It's not necessary for every custom hook in application code.`,
  ...
  {
    slug: "misc-how-do-you-handle-cleanup-in-useeffect",
    num: 317,
    category: "misc",
    title: "How do you handle cleanup in useEffect?",
    answer: `The cleanup function in \`useEffect\` is used to **clean up side effects** before the component unmounts or before the effect runs again. This prevents memory leaks, stale data, and unexpected behavior.
 ...
 **When Cleanup Runs:**
 ...
 - Before re-running the effect when dependencies change`,
  ...
  {
    slug: "misc-what-are-the-differences-between-useeffect-and-useevent-experimental",
    num: 317,
    category: "misc",
    title: "What are the differences between useEffect and useEvent (experimental)?",
    answer: `\`useEvent\` is an **experimental hook** (not yet stable in React) designed to solve the problem of creating **stable event handlers** that always access the latest props and state without causing re-renders or needing to be in dependency arrays.
 ...
 **Note:** Until \`useEvent\` is stable, you can use \`useCallback\` with \`useRef\` as a workaround for stable callbacks.`,
  ...
  {
    slug: "misc-what-are-the-best-practices-for-using-react-hooks",
    num: 318,
    category: "misc",
    title: "What are the best practices for using React Hooks?",
    answer: `Following best practices ensures your hooks are predictable, maintainable, and bug-free.
 ...
 Always return a cleanup function when subscribing to events, timers, or external data sources.`,
  ...
  {
    slug: "old-why-should-we-not-update-the-state-directly",
    num: 1,
    category: "old",
  ...
  {
    slug: "old-what-is-the-purpose-of-callback-function-as-an-argument-of-setstate",
    num: 2,
    category: "old",
    title: "What is the purpose of callback function as an argument of `setState()`?",
    answer: `The callback function provided as the second argument to \`setState\` is executed after the state has been updated and the component has re-rendered. Because \`setState()\` is asynchronous, you cannot reliably perform actions that require the updated state immediately after calling \`setState\`. The callback ensures your code runs only after the update and re-render are complete.
...
- The \`setState\` callback is still useful for one-off actions that directly follow a specific state change.`,
  ...
  {
    slug: "old-how-to-bind-methods-or-event-handlers-in-jsx-callbacks",
    num: 3,
    category: "old",
    title: "How to bind methods or event handlers in JSX callbacks?",
    answer: `There are 3 possible ways to achieve this in class components:
  ...
  {
    slug: "old-how-to-pass-a-parameter-to-an-event-handler-or-callback",
    num: 4,
    category: "old",
    title: "How to pass a parameter to an event handler or callback?",
    answer: `You can use an _arrow function_ to wrap around an _event handler_ and pass parameters:
 ...
 console.log("Hello, your ticket number is", id);
  ...
  {
    slug: "old-what-is-the-use-of-refs",
    num: 5,
    category: "old",
    title: "What is the use of refs?",
    answer: `The _ref_ is used to return a reference to the element. They _should be avoided_ in most cases, however, they can be useful when you need a direct access to the DOM element or an instance of a component.`,
  },
  {
    slug: "old-how-to-create-refs",
    num: 6,
    category: "old",
  ...
  {
    slug: "old-what-are-forward-refs",
    num: 7,
    category: "old",
    title: "What are forward refs?",
    answer: `_Ref forwarding_ is a feature that lets some components take a _ref_ they receive, and pass it further down to a child.
 ...
 <button ref={ref} className="CustomButton">
  ...
  {
    slug: "old-which-is-preferred-option-with-in-callback-refs-and-finddomnode",
    num: 8,
    category: "old",
    title: "Which is preferred option with in callback refs and findDOMNode()?",
    answer: `It is preferred to use _callback refs_ over \`findDOMNode()\` API. Because \`findDOMNode()\` prevents certain improvements in React in the future.
 ...
 render() {
  ...
  {
    slug: "old-why-are-string-refs-legacy",
    num: 9,
    category: "old",
  ...
  {
    slug: "old-what-are-the-different-phases-of-component-lifecycle",
    num: 10,
    category: "old",
...
![phases 16.2](images/phases.png)`,
  ...
  {
    slug: "old-what-are-the-lifecycle-methods-of-react",
    num: 11,
    category: "old",
    title: "What are the lifecycle methods of React?",
    answer: `Before React 16.3
...
- **componentWillUnmount** It will be used to cancel any outgoing network requests, or remove all event listeners associated with the component.`,
  ...
  {
    slug: "old-how-to-create-props-proxy-for-hoc-component",
    num: 12,
    category: "old",
    title: "How to create props proxy for HOC component?",
    answer: `You can add/edit props passed to the component using _props proxy_ pattern like this:
...
\`\`\``,
  ...
  {
    slug: "old-what-is-context",
    num: 13,
    category: "old",
    title: "What is context?",
    answer: `_Context_ provides a way to pass data through the component tree without having to pass props down manually at every level.
...
\`\`\``,
  ...
  {
    slug: "old-what-is-the-purpose-of-using-super-constructor-with-props-argument",
    num: 14,
    category: "old",
...
The above code snippets reveals that \`this.props\` is different only within the constructor. It would be the same outside the constructor.`,
  ...
  {
    slug: "old-how-to-set-state-with-a-dynamic-key-name",
    num: 15,
    category: "old",
    title: "How to set state with a dynamic key name?",
    answer: `If you are using ES6 or the Babel transpiler to transform your JSX code then you can accomplish this with _computed property names_.
...
\`\`\``,
  ...
  {
    slug: "old-what-would-be-the-common-mistake-of-function-being-called-every-time-the-component-renders",
    num: 16,
    category: "old",
...
\`\`\``,
  ...
  {
    slug: "old-what-are-error-boundaries-in-react-v16",
    num: 17,
    category: "old",
    title: "What are error boundaries in React v16?",
    answer: `_Error boundaries_ are components that catch JavaScript errors anywhere in their child component tree, log those errors, and display a fallback UI instead of the component tree that crashed.
...
\`\`\``,
  ...
  {
    slug: "old-how-are-error-boundaries-handled-in-react-v15",
    num: 18,
    category: "old",
    title: "How are error boundaries handled in React v15?",
    answer: `React v15 provided very basic support for _error boundaries_ using \`unstable_handleError\` method. It has been renamed to \`componentDidCatch\` in React v16.`,
  },
  {
    slug: "old-what-is-the-purpose-of-render-method-of-react-dom",
    num: 19,
    category: "old",
...
If the optional callback is provided, it will be executed after the component is rendered or updated.`,
  ...
  {
    slug: "old-what-will-happen-if-you-use-setstate-in-constructor",
    num: 20,
    category: "old",
    title: "What will happen if you use `setState()` in constructor?",
    answer: `When you use \`setState()\`, then apart from assigning to the object state React also re-renders the component and all its children. You would get error like this: _Can only update a mounted or mounting component._ So we need to use \`this.state\` to initialize variables inside constructor.`,
  },
  {
    slug: "old-is-it-good-to-use-setstate-in-componentwillmount-method",
    num: 21,
    category: "old",
...
\`\`\``,
  ...
  {
    slug: "old-what-will-happen-if-you-use-props-in-initial-state",
    num: 22,
    category: "old",
    title: "What will happen if you use props in initial state?",
    answer: `If the props on the component are changed without the component being refreshed, the new prop value will never be displayed because the constructor function will never update the current state of the component. The initialization of state from props only runs when the component is first created.
...
\`\`\``,
  ...
  {
    slug: "old-how-you-use-decorators-in-react",
    num: 23,
    category: "old",
    title: "How you use decorators in React?",
    answer: `You can _decorate_ your _class_ components, which is the same as passing the component into a function. **Decorators** are flexible and readable way of modifying component functionality.
...
**Note:** Decorators are a feature that didn't make it into ES7, but are currently a _stage 2 proposal_.`,
  ...
  {
    slug: "old-what-is-cra-and-its-benefits",
    num: 24,
    category: "old",
    title: "What is CRA and its benefits?",
    answer: `The \`create-react-app\` CLI tool allows you to quickly create & run React applications with no configuration step.
...
6. A build script to bundle JS, CSS, and images for production, with hashes and sourcemaps.`,
  ...
  {
    slug: "old-what-is-the-lifecycle-methods-order-in-mounting",
    num: 25,
    category: "old",
    title: "What is the lifecycle methods order in mounting?",
    answer: `The lifecycle methods are called in the following order when an instance of a component is being created and inserted into the DOM.
...
4. \`componentDidMount()\``,
  ...
  {
    slug: "old-what-are-the-lifecycle-methods-going-to-be-deprecated-in-react-v16",
    num: 26,
    category: "old",
    title: "What are the lifecycle methods going to be deprecated in React v16?",
    answer: `The following lifecycle methods going to be unsafe coding practices and will be more problematic with async rendering.
...
Starting with React v16.3 these methods are aliased with \`UNSAFE_\` prefix, and the unprefixed version will be removed in React v17.`,
  ...
  {
    slug: "old-what-is-the-purpose-of-getderivedstatefromprops-lifecycle-method",
    num: 27,
    category: "old",
    title: "What is the purpose of `getDerivedStateFromProps()` lifecycle method?",
    answer: `The new static \`getDerivedStateFromProps()\` lifecycle method is invoked after a component is instantiated as well as before it is re-rendered. It can return an object to update state, or \`null\` to indicate that the new props do not require any state updates.
...
This lifecycle method along with \`componentDidUpdate()\` covers all the use cases of \`componentWillReceiveProps()\`.`,
  ...
  {
    slug: "old-what-is-the-purpose-of-getsnapshotbeforeupdate-lifecycle-method",
    num: 28,
    category: "old",
...
This lifecycle method along with \`componentDidUpdate()\` covers all the use cases of \`componentWillUpdate()\`.`,
  ...
  {
    slug: "old-what-is-the-recommended-way-for-naming-components",
    num: 29,
    category: "old",
    title: "What is the recommended way for naming components?",
    answer: `It is recommended to name the component by reference instead of using \`displayName\`.
...
\`\`\``,
  ...
  {
    slug: "old-what-is-the-recommended-ordering-of-methods-in-component-class",
    num: 30,
    category: "old",
    title: "What is the recommended ordering of methods in component class?",
    answer: `_Recommended_ ordering of methods from _mounting_ to _render stage_:
...
14. \`render()\``,
  ...
  {
    slug: "old-why-we-need-to-pass-a-function-to-setstate",
    num: 31,
    category: "old",
...
\`\`\``,
  ...
  {
    slug: "old-why-is-ismounted-an-anti-pattern-and-what-is-the-proper-solution",
    num: 32,
    category: "old",
    title: "Why is `isMounted()` an anti-pattern and what is the proper solution?",
    answer: `The primary use case for \`isMounted()\` is to avoid calling \`setState()\` after a component has been unmounted, because it will emit a warning.
...
An optimal solution would be to find places where \`setState()\` might be called after a component has unmounted, and fix them. Such situations most commonly occur due to callbacks, when a component is waiting for some data and gets unmounted before the data arrives. Ideally, any callbacks should be canceled in \`componentWillUnmount()\`, prior to unmounting.`,
  ...
  {
    slug: "old-what-is-the-difference-between-constructor-and-getinitialstate",
    num: 33,
    category: "old",
    title: "What is the difference between constructor and getInitialState?",
    answer: `You should initialize state in the constructor when using ES6 classes, and \`getInitialState()\` method when using \`React.createClass()\`.
...
**Note:** \`React.createClass()\` is deprecated and removed in React v16. Use plain JavaScript classes instead.`,
  ...
  {
    slug: "old-can-you-force-a-component-to-re-render-without-calling-setstate",
    num: 34,
    category: "old",
    title: "Can you force a component to re-render without calling setState?",
    answer: `By default, when your component's state or props change, your component will re-render. If your \`render()\` method depends on some other data, you can tell React that the component needs re-rendering by calling \`forceUpdate()\`.
...
It is recommended to avoid all uses of \`forceUpdate()\` and only read from \`this.props\` and \`this.state\` in \`render()\`.`,
  ...
  {
    slug: "old-what-is-the-difference-between-super-and-super-props-in-react-using-es6-classes",
    num: 35,
    category: "old",
    title: "What is the difference between `super()` and `super(props)` in React using ES6 classes?",
    answer: `When you want to access \`this.props\` in \`constructor()\` then you should pass props to \`super()\` method.
...
Outside \`constructor()\` both will display same value for \`this.props\`.`,
  ...
  {
    slug: "old-what-is-the-difference-between-setstate-and-replacestate-methods",
    num: 36,
    category: "old",
  ...
  {
    slug: "old-how-to-listen-to-state-changes",
    num: 37,
    category: "old",
    title: "How to listen to state changes?",
    answer: `The \`componentDidUpdate\` lifecycle method will be called when state changes. You can compare provided state and props values with current state and props to determine if something meaningful changed.
...
**Note:** The previous releases of ReactJS also uses \`componentWillUpdate(object nextProps, object nextState)\` for state changes. It has been deprecated in latest releases.`,
  ...
  {
    slug: "old-what-is-the-recommended-approach-of-removing-an-array-element-in-react-state",
    num: 38,
    category: "old",
    title: "What is the recommended approach of removing an array element in React state?",
    answer: `The better approach is to use \`Array.prototype.filter()\` method.
...
\`\`\``,
  ...
  {
    slug: "old-is-it-possible-to-use-react-without-rendering-html",
    num: 39,
    category: "old",
    title: "Is it possible to use React without rendering HTML?",
    answer: `It is possible. Below are the possible options:
...
\`\`\``,
  ...
  {
    slug: "old-what-are-the-possible-ways-of-updating-objects-in-state",
    num: 40,
    category: "old",
    title: "What are the possible ways of updating objects in state?",
    answer: `1.  **Calling \`setState()\` with an object to merge with state:**
...
2.  **Calling \`setState()\` with a function:**
  ...
  {
    slug: "old-what-are-the-approaches-to-include-polyfills-in-your-create-react-app",
    num: 41,
    category: "old",
    title: "What are the approaches to include polyfills in your `create-react-app`?",
    answer: `There are approaches to include polyfills in create-react-app,
...
2.  **Using Polyfill service:**
  ...
  {
    slug: "old-how-to-use-https-instead-of-http-in-create-react-app",
    num: 42,
    category: "old",
    title: "How to use https instead of http in create-react-app?",
    answer: `You just need to use \`HTTPS=true\` configuration. You can edit your \`package.json\` scripts section:
...
or just run \`set HTTPS=true && npm start\``,
  ...
  {
    slug: "old-how-to-avoid-using-relative-path-imports-in-create-react-app",
    num: 43,
    category: "old",
    title: "How to avoid using relative path imports in create-react-app?",
    answer: `Create a file called \`.env\` in the project root and write the import path:
...
After that restart the development server. Now you should be able to import anything inside \`src/app\` without relative paths.`,
  ...
  {
    slug: "old-how-to-update-a-component-every-second",
    num: 44,
    category: "old",
...
\`\`\``,
  ...
  {
    slug: "old-why-is-a-component-constructor-called-only-once",
    num: 45,
    category: "old",
    title: "Why is a component constructor called only once?",
    answer: `React's _reconciliation_ algorithm assumes that without any information to the contrary, if a custom component appears in the same place on subsequent renders, it's the same component as before, so reuses the previous instance rather than creating a new one.`,
  },
  {
    slug: "old-how-to-define-constants-in-react",
    num: 46,
    category: "old",
    title: "How to define constants in React?",
    answer: `You can use ES7 \`static\` field to define constant.
...
\`\`\``,
  ...
  {
    slug: "old-how-to-programmatically-trigger-click-event-in-react",
    num: 47,
    category: "old",
    title: "How to programmatically trigger click event in React?",
    answer: `You could use the ref prop to acquire a reference to the underlying \`HTMLInputElement\` object through a callback, store the reference as a class property, then use that reference to later trigger a click from your event handlers using the \`HTMLElement.click\` method.
...
2.  Apply click event in your event handler:
  ...
  {
    slug: "old-how-to-make-ajax-call-and-in-which-component-lifecycle-methods-should-i-make-an-ajax-call",
    num: 48,
    category: "old",
...
\`\`\``,
  ...
  {
    slug: "old-what-are-render-props",
    num: 49,
    category: "old",
    title: "What are render props?",
    answer: `**Render Props** is a simple technique for sharing code between components using a prop whose value is a function. The below component uses render prop which returns a React element.
...
Libraries such as React Router and DownShift are using this pattern.`,
  ...
  {
    slug: "old-how-to-dispatch-an-action-on-load",
    num: 50,
    category: "old",
    title: "How to dispatch an action on load?",
    answer: `You can dispatch an action in \`componentDidMount()\` method and in \`render()\` method you can verify the data.
...
\`\`\``,
  ...
  {
    slug: "old-how-to-use-connect-from-react-redux",
    num: 51,
    category: "old",
    title: "How to use `connect()` from React Redux?",
    answer: `You need to follow two steps to use your store in your container:
...
2.  **Connect the above props to your container:** The object returned by the \`mapStateToProps\` function is connected to the container. You can import \`connect()\` from \`react-redux\`.
  ...
  {
    slug: "old-whats-the-purpose-of-at-symbol-in-the-redux-connect-decorator",
    num: 52,
    category: "old",
    title: "Whats the purpose of `at` symbol in the Redux connect decorator?",
    answer: `The **@** symbol is in fact a JavaScript expression used to signify decorators. _Decorators_ make it possible to annotate and modify classes and properties at design time.
...
The above examples are almost similar except the usage of decorator. The decorator syntax isn't built into any JavaScript runtimes yet, and is still experimental and subject to change. You can use babel for the decorators support.`,
  ...
  {
    slug: "old-does-the-statics-object-work-with-es6-classes-in-react",
    num: 54,
    category: "old",
    title: "Does the statics object work with ES6 classes in React?",
    answer: `No, \`statics\` only works with \`React.createClass()\`:
...
\`\`\``,
  ...
  {
    slug: "old-why-are-inline-ref-callbacks-or-functions-not-recommended",
    num: 55,
    category: "old",
    title: "Why are inline ref callbacks or functions not recommended?",
    answer: `If the ref callback is defined as an inline function, it will get called twice during updates, first with null and then again with the DOM element. This is because a new instance of the function is created with each render, so React needs to clear the old ref and set up the new one.
...
\`\`\``,
  ...
  {
    slug: "old-what-are-hoc-factory-implementations",
    num: 56,
    category: "old",
    title: "What are HOC factory implementations?",
    answer: `There are two main ways of implementing HOCs in React.
...
\`\`\``,
  ...
  {
    slug: "old-how-to-use-class-field-declarations-syntax-in-react-classes",
    num: 57,
    category: "old",
    title: "How to use class field declarations syntax in React classes?",
    answer: `React Class Components can be made much more concise using the class field declarations. You can initialize the local state without using the constructor and declare class methods by using arrow functions without the extra need to bind them.
...
\`\`\``,
  ...
  {
    slug: "old-why-do-you-not-need-error-boundaries-for-event-handlers",
    num: 58,
    category: "old",
    title: "Why do you not need error boundaries for event handlers?",
    answer: `Error boundaries do not catch errors inside event handlers.
...
Note that the above example is demonstrating regular JavaScript behavior and doesn’t use error boundaries.`,
  ...
  {
    slug: "old-what-is-the-difference-between-try-catch-block-and-error-boundaries",
    num: 59,
    category: "old",
    title: "What is the difference between try catch block and error boundaries?",
    answer: `Try catch block works with imperative code whereas error boundaries are meant for declarative code to render on the screen.
...
So if an error occurs in a **componentDidUpdate** method caused by a **setState** somewhere deep in the tree, it will still correctly propagate to the closest error boundary.`,
  ...
  {
    slug: "old-what-is-the-required-method-to-be-defined-for-a-class-component",
    num: 60,
    category: "old",
    title: "What is the required method to be defined for a class component?",
    answer: `The \`render()\` method is the only required method in a class component. i.e, All methods other than render method are optional for a class component.`,
  },
  {
    slug: "old-what-are-the-possible-return-types-of-render-method",
    num: 61,
    category: "old",
    title: "What are the possible return types of render method?",
    answer: `Below are the list of following types used and return from render method,
...
5.  **Booleans or null:** Doesn't render anything but these types are used to conditionally render content.`,
  ...
  {
    slug: "old-what-is-the-main-purpose-of-constructor",
    num: 62,
    category: "old",
    title: "What is the main purpose of constructor?",
    answer: `The constructor is mainly used for two purposes,
...
\`\`\``,
  ...
  {
    slug: "old-is-it-mandatory-to-define-constructor-for-react-component",
    num: 63,
    category: "old",
    title: "Is it mandatory to define constructor for React component?",
    answer: `No, it is not mandatory. i.e, If you don’t initialize state and you don’t bind methods, you don’t need to implement a constructor for your React component.`,
  },
  {
    slug: "old-why-should-not-call-setstate-in-componentwillunmount",
    num: 64,
    category: "old",
    title: "Why should not call setState in componentWillUnmount?",
    answer: `You should not call \`setState()\` in \`componentWillUnmount()\` because once a component instance is unmounted, it will never be mounted again.`,
  },
  {
    slug: "old-what-is-the-purpose-of-getderivedstatefromerror",
    num: 65,
    category: "old",
    title: "What is the purpose of getDerivedStateFromError?",
    answer: `This lifecycle method is invoked after an error has been thrown by a descendant component. It receives the error that was thrown as a parameter and should return a value to update state.
...
\`\`\``,
  ...
  {
    slug: "old-what-is-the-methods-order-when-component-re-rendered",
    num: 66,
    category: "old",
    title: "What is the methods order when component re-rendered?",
    answer: `An update can be caused by changes to props or state. The below methods are called in the following order when a component is being re-rendered.
...
5.  componentDidUpdate()`,
  ...
  {
    slug: "old-what-are-the-methods-invoked-during-error-handling",
    num: 67,
    category: "old",
    title: "What are the methods invoked during error handling?",
    answer: `Below methods are called when there is an error during rendering, in a lifecycle method, or in the constructor of any child component.

1.  static getDerivedStateFromError()
2.  componentDidCatch()`,
  },
  {
    slug: "old-what-is-the-purpose-of-unmountcomponentatnode-method",
    num: 68,
    category: "old",
...
\`\`\``,
  ...
  {
    slug: "old-what-are-the-limitations-with-hocs",
    num: 69,
    category: "old",
    title: "What are the limitations with HOCs?",
    answer: `Higher-order components come with a few caveats apart from its benefits. Below are the few listed in an order,
...
3.  **Refs aren’t passed through:**
  ...
  {
    slug: "old-how-to-debug-forwardrefs-in-devtools",
    num: 70,
    category: "old",
    title: "How to debug forwardRefs in DevTools?",
    answer: `**React.forwardRef** accepts a render function as parameter and DevTools uses this function to determine what to display for the ref forwarding component.
...
\`\`\``,
  ...
  {
    slug: "old-is-it-good-to-use-arrow-functions-in-render-methods",
    num: 71,
    category: "old",
    title: "Is it good to use arrow functions in render methods?",
    answer: `Yes, You can use. It is often the easiest way to pass parameters to callback functions. But you need to optimize the performance while using it.
...
**Note:** Using an arrow function in render method creates a new function each time the component renders, which may have performance implications`,
  ...
  {
    slug: "old-how-do-you-say-that-state-updates-are-merged",
    num: 72,
    category: "old",
    title: "How do you say that state updates are merged?",
    answer: `When you call setState() in the component, React merges the object you provide into the current state.
...
As mentioned in the above code snippets, \`this.setState({comments})\` updates only comments variable without modifying or replacing \`posts\` variable.`,
  ...
  {
    slug: "old-how-do-you-pass-arguments-to-an-event-handler",
    num: 73,
    category: "old",
    title: "How do you pass arguments to an event handler?",
    answer: `During iterations or loops, it is common to pass an extra parameter to an event handler. This can be achieved through arrow functions or bind method.
...
In the both approaches, the synthetic argument \`e\` is passed as a second argument. You need to pass it explicitly for arrow functions and it will be passed automatically for \`bind\` method.`,
  ...
  {
    slug: "old-how-to-prevent-component-from-rendering",
    num: 74,
    category: "old",
    title: "How to prevent component from rendering?",
    answer: `You can prevent component from rendering by returning null based on specific condition. This way it can conditionally render component.
...
In the above example, the \`greeting\` component skips its rendering section by applying condition and returning null value.`,
  ...
  {
    slug: "old-give-an-example-on-how-to-use-context",
    num: 75,
    category: "old",
    title: "Give an example on How to use context?",
    answer: `**Context** is designed to share data that can be considered **global** for a tree of React components.
...
\`\`\``,
  ...
  {
    slug: "old-how-do-you-use-contexttype",
    num: 76,
    category: "old",
    title: "How do you use contextType?",
    answer: `ContextType is used to consume the context object. The contextType property can be used in two ways,
...
\`\`\``,
  ...
  {
    slug: "old-how-do-you-solve-performance-corner-cases-while-using-context",
    num: 78,
    category: "old",
    title: "How do you solve performance corner cases while using context?",
    answer: `The context uses reference identity to determine when to re-render, there are some gotchas that could trigger unintentional renders in consumers when a provider’s parent re-renders.
...
\`\`\``,
  ...
  {
    slug: "old-what-is-the-purpose-of-forward-ref-in-hocs",
    num: 79,
    category: "old",
...
\`\`\``,
  ...
  {
    slug: "old-is-ref-argument-available-for-all-functions-or-class-components",
    num: 80,
    category: "old",
    title: "Is ref argument available for all functions or class components?",
    answer: `Regular function or class components don’t receive the ref argument, and ref is not available in props either. The second ref argument only exists when you define a component with React.forwardRef call.`,
  },
  {
    slug: "old-why-do-you-need-additional-care-for-component-libraries-while-using-forward-refs",
    num: 81,
    category: "old",
  ...
  {
    slug: "old-how-to-create-react-class-components-without-es6",
    num: 82,
    category: "old",
    title: "How to create react class components without ES6?",
    answer: `If you don’t use ES6 then you may need to use the create-react-class module instead. For default props, you need to define getDefaultProps() as a function on the passed object. Whereas for initial state, you have to provide a separate getInitialState method that returns the initial state.
...
**Note:** If you use createReactClass then auto binding is available for all methods. i.e, You don't need to use \`.bind(this)\` with in constructor for event handlers.`,
  ...
  {
    slug: "old-is-it-possible-to-use-react-without-jsx",
    num: 83,
    category: "old",
    title: "Is it possible to use react without JSX?",
    answer: `Yes, JSX is not mandatory for using React. Actually it is convenient when you don’t want to set up compilation in your build environment. Each JSX element is just syntactic sugar for calling \`React.createElement(component, props, ...children)\`.
...
\`\`\``,
  ...
  {
    slug: "old-how-do-you-create-hoc-using-render-props",
    num: 84,
    category: "old",
    title: "How do you create HOC using render props?",
    answer: `You can implement most higher-order components (HOC) using a regular component with a render prop. For example, if you would prefer to have a withMouse HOC instead of a <Mouse> component, you could easily create one using a regular <Mouse> with a render prop.
...
This way render props gives the flexibility of using either pattern.`,
  ...
  {
    slug: "old-what-is-react-scripts",
    num: 85,
    category: "old",
    title: "What is react scripts?",
    answer: `The \`react-scripts\` package is a set of scripts from the create-react-app starter pack which helps you kick off projects without configuring. The \`react-scripts start\` command sets up the development environment and starts a server, as well as hot module reloading.`,
  },
  {
    slug: "old-what-are-the-features-of-create-react-app",
    num: 86,
    category: "old",
    title: "What are the features of create react app?",
    answer: `Below are the list of some of the features provided by create react app.
...
7.  An offline-first service worker and a web app manifest, meeting all the Progressive Web App criteria.`,
  ...
  {
    slug: "old-what-is-the-purpose-of-rendertonodestream-method",
    num: 87,
    category: "old",
...
**Note:** Remember this method is not available in the browser but only server.`,
  ...
  {
    slug: "old-how-do-you-get-redux-scaffolding-using-create-react-app",
    num: 88,
    category: "old",
    title: "How do you get redux scaffolding using create-react-app?",
    answer: `Redux team has provided official redux+js or redux+typescript templates for create-react-app project. The generated project setup includes,
...
\`\`\``,
  ...
  {
    slug: "old-what-is-state-mutation-and-how-to-prevent-it",
    num: 89,
    category: "old",
...
export function getQuestionBySlug(slug: string): ReactInterviewQuestion | undefined {
  return REACT_INTERVIEW_QUESTIONS.find((q) => q.slug === slug);
}

export function getQuestionsByCategory(category: ReactInterviewCategoryId): ReactInterviewQuestion[] {
  return REACT_INTERVIEW_QUESTIONS.filter((q) => q.category === category);
}
