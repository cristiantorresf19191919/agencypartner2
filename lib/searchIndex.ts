...
const keywordMap: Record<string, string[]> = {
  ...
  "custom-hooks": ["hooks", "custom hooks", "react hooks", "use hook"],
  "hoc": ["higher order component", "hoc", "wrapper", "enhancer"],
  "render-props": ["render props", "render function", "children function"],
  ...
  "render-props": ["render props", "headless", "inversion of control", "composition", "render function"],
  ...
  "custom-hooks": ["custom hooks", "reusable logic", "hook patterns", "useFormInput", "useLocalStorage"],
