...
export const blogCategories: BlogCategory[] = [
  ...
  },
  {
    ...
    posts: [
      ...
      },
      {
        ...
        description: "Understand serverless architecture from core concepts to production patterns. Learn FaaS, event-driven pipelines, async workers, managed services, cold starts, design principles, and when serverless is the right choice. Animated diagrams and interactive challenges.",
        icon: "⚡",
        color: "from-violet-500 to-purple-600",
        slug: "serverless-applications",
        topics: [
  ...
  },
  {
    ...
    description: "Master developer tools, Git workflows, CLI productivity, and AI-assisted development patterns for maximum efficiency.",
    icon: "🛠️",
    color: "from-gray-500 to-slate-600",
    slug: "developer-tools-workflow",
    posts: [
      {
        id: "git-worktrees-claude-code",
        title: "Git Worktrees & Claude Code: Parallel AI Development",
        description: "Master git worktrees for parallel development with Claude Code. Learn worktree lifecycle, subagent isolation, batch processing, hook configurations, and multi-branch workflows.",
        icon: "🌳",
        color: "from-emerald-500 to-green-600",
        slug: "git-worktrees-claude-code",
        topics: [
