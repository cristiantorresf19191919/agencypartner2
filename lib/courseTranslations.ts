...
> = {
  ...
  "react-32": { title: "React 19 (11): Hook use() para Promises" },
  "react-33": { title: "React 19 (12): ref como prop" },
  "react-34": { title: "React 19 (13): metadatos del documento" },
  "react-35": { title: "React 19 (14): carga de assets con Suspense" },
  "react-36": { title: "React 19 (15): conceptos de Server Components" },
  "react-37": { title: "React 19 (16): conceptos del React Compiler" },
  "react-38": { title: "React 19 (17): reto avanzado — dashboard en tiempo real" },
  "react-39": { title: "React 32: testing básico con React Testing Library" },
  "react-40": { title: "React 33: probando interacciones de usuario" },
  "react-41": { title: "React 34: probando custom hooks" },
  "react-42": { title: "React 35: patrón Compound Components" },
  "react-43": { title: "React 36: patrón Render Props" },
  "react-44": { title: "React 37: patrón Headless UI" },
  "react-45": { title: "React 38: fundamentos de TypeScript con React" },
  "react-46": { title: "React 39: patrones avanzados de TypeScript" },
  "react-47": { title: "React 40: gestión de formularios con React Hook Form" },
  "react-48": { title: "React 41: patrones de fetching de datos" },
  "react-49": { title: "React 42: profiling de rendimiento" },
  "react-50": { title: "React 43: accesibilidad en React" },
};
